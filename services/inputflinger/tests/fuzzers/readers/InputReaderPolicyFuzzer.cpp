...
extern "C" int LLVMFuzzerTestOneInput(uint8_t* data, size_t size) {
    ...
    static const std::string uniqueId =
            fdp.ConsumeRandomLengthString(50) + ":" + fdp.ConsumeIntegralInRange<char>(0, 10);
    ...
    mFakePolicy->addDisplayViewport(fdp.ConsumeIntegralInRange<int32_t>(0, kMaxRangeSize),
                                    fdp.ConsumeIntegralInRange<int32_t>(0, kMaxRangeSize),
                                    fdp.ConsumeIntegralInRange<int32_t>(0, kMaxRangeSize),
    ...
    const std::string uniqueId1 = fdp.ConsumeRandomLengthString(50);
    const std::string uniqueId2 = fdp.ConsumeRandomLengthString(50);
    int32_t displayId1 = fdp.ConsumeIntegralInRange(0, 10);
    int32_t displayId2 = fdp.ConsumeIntegralInRange(0, 10);
