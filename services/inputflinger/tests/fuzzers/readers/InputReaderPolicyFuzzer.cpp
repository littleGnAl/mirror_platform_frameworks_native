...
extern "C" int LLVMFuzzerTestOneInput(uint8_t* data, size_t size) {
    ...
    static const std::string uniqueId = tester.ConsumeRandomLengthString(50) + ":" +
            (char)tester.ConsumeIntegralInRange(0, 10); // TODO: Bigger Range might give us better
                                                        // coverage?
    ...
    mFakePolicy->addDisplayViewport(tester.ConsumeIntegralInRange(0, MAX_RANGE_SIZE),
                                    tester.ConsumeIntegralInRange(0, MAX_RANGE_SIZE),
                                    tester.ConsumeIntegralInRange(0, MAX_RANGE_SIZE),
    ...
    const std::string internalUniqueId =
            tester.ConsumeRandomLengthString(50) + ":" + (char)tester.ConsumeIntegralInRange(0, 10);
