...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size) {
    ...
    mFakePolicy->addDisplayViewport(displayId1, tester.ConsumeIntegralInRange(0, MAX_RANGE_SIZE),
    ...
    mFakePolicy->addDisplayViewport(displayId2, tester.ConsumeIntegralInRange(0, MAX_RANGE_SIZE),
                                    tester.ConsumeIntegralInRange(0, MAX_RANGE_SIZE),
