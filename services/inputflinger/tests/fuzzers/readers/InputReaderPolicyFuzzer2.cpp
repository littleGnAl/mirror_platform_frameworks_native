...
extern "C" int LLVMFuzzerTestOneInput(uint8_t *data, size_t size) {
    ...
    std::string uniqueId1 = fdp.ConsumeRandomLengthString(50);
    std::string uniqueId2 = fdp.ConsumeRandomLengthString(50);
    int32_t displayId1 = fdp.ConsumeIntegralInRange(0, 10);
    int32_t displayId2 = fdp.ConsumeIntegralInRange(0, 10);
    uint8_t hdmi1 = fdp.ConsumeIntegralInRange(0, 861);
    uint8_t hdmi2 = fdp.ConsumeIntegralInRange(313, 1001);
    uint8_t hdmi3 = fdp.ConsumeIntegralInRange(1337, 2480);
