...
#ifndef CURSORINPUTFUZZER_INPUTREADERHELPERCLASSES_H_
#define CURSORINPUTFUZZER_INPUTREADERHELPERCLASSES_H_
...
public:
    ...
    virtual void setDisplayViewport(const DisplayViewport &displayViewport){};
...
protected:
    ...
    virtual void SetUp() { mFakePolicy = new FakeInputReaderPolicy(); }
    virtual void TearDown() { mFakePolicy.clear(); }
    virtual ~InputReaderPolicyTest() {}
};
} // namespace android

#endif // CURSORINPUTFUZZER_INPUTREADERHELPERCLASSES_H_
