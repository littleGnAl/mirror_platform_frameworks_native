...
extern "C" int LLVMFuzzerTestOneInput(uint8_t* data, size_t size) {
    ...
    InputMapperTest::process(mapper, ARBITRARY_TIME, EV_MSC, tester.ConsumeIntegralInRange(-1, 9),
                             USAGE_A);
    ...
    // Toggle caps lock on.
    int32_t keyToPressAndRelease = tester.ConsumeIntegralInRange<int32_t>(-1, 465);
