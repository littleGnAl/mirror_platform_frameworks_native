...
extern "C" int LLVMFuzzerTestOneInput(uint8_t* data, size_t size) {
    ...
    mmt->prepareDisplay(fdp.ConsumeIntegralInRange(-1, 4));
    ...
    int32_t x1 = fdp.ConsumeIntegralInRange<int32_t>(0, 1000),
            y1 = fdp.ConsumeIntegralInRange<int32_t>(0, 1250),
            x2 = fdp.ConsumeIntegralInRange<int32_t>(0, 500),
            y2 = fdp.ConsumeIntegralInRange<int32_t>(0, 900);
    ...
    // Move.
    x1 += fdp.ConsumeIntegralInRange<int32_t>(0, 25);
    y1 += fdp.ConsumeIntegralInRange<int32_t>(0, 25);
    x2 += fdp.ConsumeIntegralInRange<int32_t>(0, 25);
    y2 -= fdp.ConsumeIntegralInRange<int32_t>(0, 25);
    mmt->processPosition(mapper, x1, y1);
    mmt->processMTSync(mapper);
    mmt->processPosition(mapper, x2, y2);
    mmt->processMTSync(mapper);
    ...
    // Second finger up.
    x1 += fdp.ConsumeIntegralInRange<int32_t>(-800, 800);
    y1 -= fdp.ConsumeIntegralInRange<int32_t>(-800, 800);
    mmt->processPosition(mapper, x1, y1);
    mmt->processMTSync(mapper);
    mmt->processSync(mapper);
    ...
    mmt->addConfigurationProperty("touch.size.scale", fdp.ConsumeRandomLengthString(8).data());
    mmt->addConfigurationProperty("touch.size.bias", fdp.ConsumeRandomLengthString(8).data());
    mmt->addConfigurationProperty("touch.size.isSummed", fdp.ConsumeRandomLengthString(8).data());
    mmt->addConfigurationProperty("touch.size.calibration",
                                  fdp.ConsumeRandomLengthString(8).data());
    mmt->addConfigurationProperty("touch.pressure.calibration",
                                  fdp.ConsumeRandomLengthString(8).data());
    mmt->addConfigurationProperty("touch.pressure.scale", fdp.ConsumeRandomLengthString(8).data());

    int32_t axesFlag = 0;
    int32_t loopCount = fdp.ConsumeIntegralInRange(0, 12);
    for (int32_t i = 0; i < loopCount; i++) {
        switch (fdp.ConsumeIntegralInRange(0, 11)) {
            case 0:
            ...
            case 7:
                ...
                break;
            case 8:
                axesFlag |= fdp.ConsumeIntegral<int32_t>();
                break;
            case 9:
                axesFlag |= fdp.ConsumeIntegral<int32_t>();
                break;
    ...
    int32_t rawX = fdp.ConsumeIntegralInRange(-1, 1025);
    int32_t rawY = fdp.ConsumeIntegralInRange(-1, 1025);
    int32_t rawTouchMajor = fdp.ConsumeIntegralInRange(-1, 129);
    int32_t rawTouchMinor = fdp.ConsumeIntegralInRange(-1, 129);
    int32_t rawToolMajor = fdp.ConsumeIntegralInRange(-1, 129);
    int32_t rawToolMinor = fdp.ConsumeIntegralInRange(-1, 129);
    int32_t rawPressure = fdp.ConsumeIntegralInRange(-1, 129);
    int32_t rawDistance = fdp.ConsumeIntegralInRange(-1, 129);
    int32_t rawOrientation = fdp.ConsumeIntegralInRange(-1, 129);
    int32_t id = fdp.ConsumeIntegralInRange(-1, 129);
    ...
    // loop the buttons
    mmt->processKey(mapper2, fdp.ConsumeIntegralInRange(-1, 289), fdp.ConsumeBool());
    mmt->processSync(mapper2);
    ...
    // stylus
    mmt->processKey(mapper2, fdp.ConsumeIntegralInRange(0x100, 0x151), fdp.ConsumeBool());
    mmt->processKey(mapper2, fdp.ConsumeIntegralInRange(0x100, 0x151), fdp.ConsumeBool());
    mmt->processSync(mapper2);

    // MT tool type trumps BTN tool types: MT_TOOL_PEN
    mmt->processToolType(mapper2, fdp.ConsumeIntegralInRange(-1, 17));
    mmt->processSync(mapper2);
    ...
    mmt->processPosition(mapper12, fdp.ConsumeIntegralInRange(-1, 289),
                         fdp.ConsumeIntegralInRange(-1, 289));
    mmt->processTimestamp(mapper12, fdp.ConsumeIntegralInRange(0, 3));
    ...
    mmt->processPosition(mapper18, fdp.ConsumeIntegralInRange(-1, 289),
                         fdp.ConsumeIntegralInRange(-1, 289));
    ...
    for (int32_t orientation : {DISPLAY_ORIENTATION_0, DISPLAY_ORIENTATION_90,
        ...
        mmt->processPosition(mapper19, fdp.ConsumeIntegralInRange(-1, 289),
                             fdp.ConsumeIntegralInRange(-1, 289));
    ...
    mmt->processPosition(mapper20, fdp.ConsumeIntegralInRange(-1, 289),
                         fdp.ConsumeIntegralInRange(-1, 289));
