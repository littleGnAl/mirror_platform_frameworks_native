...
EventEntry::EventEntry(uint32_t sequenceNum, int32_t type,
...
KeyEntry::KeyEntry(uint32_t sequenceNum, nsecs_t eventTime,
...
MotionEntry::MotionEntry(uint32_t sequenceNum, nsecs_t eventTime, int32_t deviceId,
...
DispatchEntry::DispatchEntry(EventEntry* eventEntry,
