...
public:
    ...
    virtual void vibrate(int32_t deviceId, const VibrationElement* pattern, size_t patternSize,
...
public:
    ...
    bool markSupportedKeyCodes(uint32_t sourceMask, size_t numCodes,
            const int32_t* keyCodes, uint8_t* outFlags);
    void vibrate(const VibrationElement* pattern, size_t patternSize, ssize_t repeat,
            int32_t token);
...
public:
    ...
    virtual bool markSupportedKeyCodes(uint32_t sourceMask, size_t numCodes,
            const int32_t* keyCodes, uint8_t* outFlags);
    virtual void vibrate(const VibrationElement* pattern, size_t patternSize, ssize_t repeat,
            int32_t token);
...
private:
    bool mVibrating;
    VibrationElement mPattern[MAX_VIBRATE_PATTERN_SIZE];
    size_t mPatternSize;
    ssize_t mRepeat;
    int32_t mToken;
    ssize_t mIndex;
