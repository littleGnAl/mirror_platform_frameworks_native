...
void EventHub::vibrate(int32_t deviceId, const VibrationElement& element) {
    ...
    if (device && device->hasValidFd()) {
        ...
        // evdev FF_RUMBLE effect only supports two channels of vibration, so take the first two
        ...
        // Convert element.duration to milliseconds (from nanoseconds) rounding to the next
        // millisecond.
