...
bool InputState::isHovering(int32_t deviceId, uint32_t source,
...
bool InputState::trackKey(const KeyEntry* entry,
...
bool InputState::trackMotion(const MotionEntry* entry,
        int32_t action, int32_t flags) {
...
ssize_t InputState::findMotionMemento(const MotionEntry* entry,
        bool hovering) const {
...
void InputState::addMotionMemento(const MotionEntry* entry,
...
void InputState::setFallbackKey(int32_t originalKeyCode,
...
bool InputState::shouldCancelKey(const KeyMemento& memento,
