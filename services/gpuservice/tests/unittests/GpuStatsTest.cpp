...
public:
    GpuStatsTest() : looper(Looper::prepare(0 /* opts */)) {
        ...
        // if(!waitOnGdbIsDone) {
        //     waitOnGdbIsDone = true;
        //     ALOGD("**** Connect your gdb");
        //     sleep(10);
        //     ALOGD("**** resuming the app");
        // }
    }
...
bool GpuStatsTest::waitOnGdbIsDone = false;
