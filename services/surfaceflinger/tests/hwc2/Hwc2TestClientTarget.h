...
public:
    int getBuffer(const Hwc2TestLayers& layers,
            ...
            bool clearClientTarget, int32_t displayWidth,
            int32_t displayHeight, buffer_handle_t* outHandle,
...
public:
    Hwc2TestClientTargetSupport(hwc2_test_coverage_t coverage,
    ...
    const std::pair<int32_t, int32_t> getBufferArea() const;
