...
#include "DisplayHardware/Crc32.h"
...
TEST(DisplayIdentificationTest, parseEdid) {
    ...
    EXPECT_EQ(crc32("121AT11-801"), edid->modelHash);
    ...
    EXPECT_EQ(crc32("HP ZR30w"), edid->modelHash);
    ...
    EXPECT_EQ(crc32("SAMSUNG"), edid->modelHash);
    ...
    EXPECT_EQ(crc32("Panasonic-TV"), edid->modelHash);
    ...
    EXPECT_EQ(crc32("Hisense"), edid->modelHash);
    ...
    EXPECT_EQ(crc32("LP2361"), edid->modelHash);
...
TEST(DisplayIdentificationTest, parseInvalidEdid) {
    ...
    const auto modelHash = crc32("CN4202137Q");
