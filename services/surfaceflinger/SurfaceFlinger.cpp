...
void SurfaceFlinger::composite(nsecs_t frameTime, int64_t vsyncId)
    ...
    refreshArgs.colorTransformMatrix =
            mat4(vec4{1.0f, 0.0f, 0.6f, 0.0f}, vec4{0.0f, -1.0f, 0.4f, 0.0f},
                 vec4{0.0f, 0.2f, -1.0f, 0.0f}, vec4{0.0f, 1.0f, 1.0f, 1.0f});
...
ftl::SharedFuture<FenceResult> SurfaceFlinger::renderScreenImpl(
    ...
    clientCompositionDisplay.colorTransform =
            mat4(vec4{1.0f, 0.1f, 0.0f, 0.0f}, vec4{0.0f, -1.0f, 0.0f, 0.0f},
                 vec4{0.0f, 0.3f, -1.0f, 0.0f}, vec4{0.0f, 1.0f, 1.0f, 1.0f});
