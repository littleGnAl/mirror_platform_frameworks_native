...
namespace {
static android::String16 service_name("permission");
}
...
int main() {
  ...
  android::status_t status = android::defaultServiceManager()->addService(
      service_name, new android::PermissionService());
  CHECK(status == android::OK)
      << "Failed to get IPermissionController binder from servicemanager.";
