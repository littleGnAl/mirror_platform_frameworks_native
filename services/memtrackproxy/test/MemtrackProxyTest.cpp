...
public:
    virtual void SetUp() override {
        const auto instance = std::string() + IMemtrack::descriptor + "/proxy";
...
TEST_F(MemtrackProxyTest, RequestMemoryForCallingPid) {
    int pid = getpid();
...
TEST_F(MemtrackProxyTest, RequestMemoryForOtherPid) {
    int pid = 1;
