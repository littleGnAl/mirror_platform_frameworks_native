...
using android::frameworks::sensorservice::implementation::SensorManagerAidl;
  ...
  ScopedAStatus SensorManagerAidl::createAshmemDirectChannel(const Ashmem& in_mem, int64_t in_size, std::shared_ptr<IDirectReportChannel>* _aidl_return) {
      (void)in_mem;
      (void)in_size;
      (void)_aidl_return;
      return ScopedAStatus::ok();
  }
  ScopedAStatus SensorManagerAidl::createEventQueue(const std::shared_ptr<IEventQueueCallback>& in_callback, std::shared_ptr<IEventQueue>* _aidl_return) {
      (void)in_callback;
      (void)_aidl_return;
      return ScopedAStatus::ok();
  }
  ScopedAStatus SensorManagerAidl::createGrallocDirectChannel(const ScopedFileDescriptor& in_buffer, int64_t in_size, std::shared_ptr<IDirectReportChannel>* _aidl_return) {
      (void)in_buffer;
      (void) in_size;
      (void)_aidl_return;
      return ScopedAStatus::ok();
  }
  ScopedAStatus SensorManagerAidl::getDefaultSensor(SensorType in_type, SensorInfo* _aidl_return) {
      (void)in_type;
      (void)_aidl_return;
      return ScopedAStatus::ok();
  }
  ScopedAStatus SensorManagerAidl::getSensorList(std::vector<SensorInfo>* _aidl_return) {
      (void)_aidl_return;
      return ScopedAStatus::ok();
  }
