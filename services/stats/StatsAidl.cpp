...
bool write_atom_annotation(AStatsEvent* event,
...
bool write_atom_field_annotation(AStatsEvent* event,
        ...
        switch (valueAnnotation.annotationId) {
            ...
            case AnnotationIds::PRIMARY_FIELD_FIRST_UID: {
                AStatsEvent_addBoolAnnotation(
                        event, ASTATSLOG_ANNOTATION_ID_PRIMARY_FIELD_FIRST_UID, true);
                break;
            }
            ...
            case AnnotationIds::TRIGGER_STATE_RESET: {
                AStatsEvent_addInt32Annotation(event, ASTATSLOG_ANNOTATION_ID_TRIGGER_STATE_RESET,
                                               0);
                break;
            }
            default: {
...
ndk::ScopedAStatus StatsHal::reportVendorAtom(const VendorAtom& vendorAtom) {
    ...
    if (vendorAtom.atomAnnotations) {
        write_atom_annotation(event, *vendorAtom.atomAnnotations);
    }
