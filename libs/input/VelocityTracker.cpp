 ...
 */
static bool solveUnweightedLeastSquaresDeg2(const float* x, const float* y, size_t count,
        float* outCoeff) {
...
bool LeastSquaresVelocityTrackerStrategy::getEstimator(uint32_t id,
    ...
    if (degree == 2 && mWeighting == WEIGHTING_NONE) {
        ...
        if (solveUnweightedLeastSquaresDeg2(time, x, m, outEstimator->xCoeff)
                && solveUnweightedLeastSquaresDeg2(time, y, m, outEstimator->yCoeff)) {
