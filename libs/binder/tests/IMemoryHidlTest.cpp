...
static void test2() {
    cout << "Test: android::hardware::HidlAshmem: ";
    sp<HidlAshmem> o = android::hardware::HidlAshmem::getInstance(888, 256);
    ASSERT(o != nullptr);
    ASSERT(o->name() == "ashmem");
    ASSERT(o->handle() != nullptr);
    ASSERT(HidlAshmem::valid(*o));
    cout << "OK" << endl;
}
