...
public:
    ...
    GENERATE_GETTER_SETTER(BinderArray, std::vector<android::sp<IBinder>>);
...
public:
    ...
    void recordReplay(Status (IBinderRecordReplayTest::*set)(T), V recordedValue,
                      Status (IBinderRecordReplayTest::*get)(U), V changedValue) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatString) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatSingleDataParcelable) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatByteArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatBooleanArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatCharArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatIntArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatFloatArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatLongArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatDoubleArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatStringArray) {
...
TEST_F(BinderClearBuf, RecordReplayRepeatBinder) {
    sp<IBinder> savedBinder = IInterface::asBinder(defaultServiceManager());
    sp<IBinder> changedBinder = defaultServiceManager()->getService(kServerName);
    recordReplay(&IBinderRecordReplayTest::setBinder, savedBinder,
                 &IBinderRecordReplayTest::getBinder, changedBinder);
}

TEST_F(BinderClearBuf, RecordReplayRepeatSingleDataParcelableArray) {
