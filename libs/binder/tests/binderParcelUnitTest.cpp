...
TEST(Parcel, AppendFromEmpty) {
    ...
    ASSERT_EQ(0, p1.appendFrom(&p2, 0, p2.dataSize()));
...
TEST(Parcel, AppendPlainDataPartial) {
    ...
    ASSERT_EQ(0, p1.appendFrom(&p2, 0, 8));
...
TEST(Parcel, AppendWithBinderPartial) {
    ...
    ASSERT_EQ(0, p1.appendFrom(&p2, 0, 8)); // BAD: 4 bytes into strong binder
...
TEST(Parcel, AppendWithFdPartial) {
    ...
    ASSERT_EQ(0, p1.appendFrom(&p2, 0, 8)); // BAD: 4 bytes into binder
