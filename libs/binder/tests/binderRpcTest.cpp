...
public:
    ...
    public:
        ...
        [[nodiscard]] AssertionResult setUp() {
            ...
            mPostConnect = std::bind(&Server::defaultPostConnect, _1, _2);
            mSetup = true;
    ...
    private:
        ...
        bool mSetup = false;
        // The function invoked after connection and handshake. By default, setUp() sets it to
        // |defaultPostConnect| to send |kMessage| to the client.
