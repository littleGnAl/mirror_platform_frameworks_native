...
ProcessSessionBase::~ProcessSessionBase() {}

class LinuxProcessSession : public ProcessSessionBase {
public:
...
using BinderRpc = BinderRpcImpl<LinuxProcessSession>;
...
template <>
std::string BinderRpcImpl<LinuxProcessSession>::PrintParamInfo(
...
template <>
template <>
std::unique_ptr<LinuxProcessSession>
BinderRpcImpl<LinuxProcessSession>::createRpcTestSocketServerProcessEtc(
...
// Specialization that returns a std::unique_ptr<ProcessSessionBase>
// that can be used from other files without needing the definition
// of LinuxProcessSession
template <>
template <>
std::unique_ptr<ProcessSessionBase>
BinderRpcImpl<ProcessSessionBase>::createRpcTestSocketServerProcessEtc(
        const BinderRpcOptions& options) {
    return BinderRpcImpl<LinuxProcessSession>::createRpcTestSocketServerProcessEtc<
            LinuxProcessSession>(options);
}
