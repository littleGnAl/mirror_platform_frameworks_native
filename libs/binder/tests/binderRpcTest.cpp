...
#ifndef BINDER_RPC_SINGLE_THREADED // Single-threaded servers do not support concurrent sessions
...
#if !defined(BINDER_RPC_SINGLE_THREADED) && !defined(BINDER_NO_KERNEL_IPC)
...
TEST(BinderRpc, Java) {
#if !defined(__ANDROID__) || defined(BINDER_NO_KERNEL_IPC)
