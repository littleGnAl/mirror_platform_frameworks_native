...
static const std::vector<std::function<void(FuzzedDataProvider*, IBinder*)>> gIBinderOperations =
        {[](FuzzedDataProvider*, IBinder* ibinder) -> void { ibinder->getInterfaceDescriptor(); },
         ...
         [](FuzzedDataProvider* fdp, IBinder* ibinder) -> void {
             ...
             ibinder->attachObject(fdp->ConsumeBool() ? reinterpret_cast<void *>(&objectID) : nullptr,
                                   fdp->ConsumeBool() ? reinterpret_cast<void *>(&object) : nullptr,
                                   fdp->ConsumeBool() ? reinterpret_cast<void *>(&cleanup_cookie) : nullptr,
                                   func);
         },
         [](FuzzedDataProvider* fdp, IBinder* ibinder) -> void {
           if(fdp->ConsumeBool()) {
             ...
             ibinder->findObject(fdp->ConsumeBool() ? reinterpret_cast<void *>(&objectID) : nullptr);
           }
         },
         [](FuzzedDataProvider* fdp, IBinder* ibinder) -> void {
             if(fdp->ConsumeBool()) {
               ...
               ibinder->detachObject(fdp->ConsumeBool() ? reinterpret_cast<void *>(&objectID) : nullptr);
             }
         }};
} // namespace android
