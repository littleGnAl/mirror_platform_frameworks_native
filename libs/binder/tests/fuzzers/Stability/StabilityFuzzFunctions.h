 ...
 */
static const std::vector<std::function<void(FuzzedDataProvider*, android::sp<android::IBinder>)>>
        stability_operations = {
                // markCompilationUnit(IBinder* binder)
                [](FuzzedDataProvider*, android::sp<android::IBinder> bbinder) -> void {
                ...
                [](FuzzedDataProvider* fdp, android::sp<android::IBinder> bbinder) -> void {
