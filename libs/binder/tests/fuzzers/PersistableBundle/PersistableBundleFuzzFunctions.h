...
#ifndef PERSISTABLE_BUNDLE_FUZZER_FUNCTIONS_H_
#define PERSISTABLE_BUNDLE_FUZZER_FUNCTIONS_H_
...
static const std::vector<
        std::function<void(FuzzedDataProvider*, std::shared_ptr<os::PersistableBundle>, String16*)>>
        persistable_bundle_operations =
                {[](FuzzedDataProvider*, std::shared_ptr<os::PersistableBundle> p_bundle,
                 ...
                 [](FuzzedDataProvider* fdp, std::shared_ptr<os::PersistableBundle> p_bundle,
                    String16* key) -> void {
...
#endif // PERSISTABLE_BUNDLE_FUZZER_FUNCTIONS_H_
