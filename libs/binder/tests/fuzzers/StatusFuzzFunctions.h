...
#ifndef STATUS_FUZZER_FUNCTIONS_H_
#define STATUS_FUZZER_FUNCTIONS_H_
        ...
        status_operations = {
                ...
                [](FuzzedDataProvider* fdp, binder::Status*, Parcel*) -> void {
                    std::string message_str =
                            fdp->ConsumeRandomLengthString(fdp->remaining_bytes());
                    String8 message(message_str.c_str());
                    binder::Status::fromExceptionCode(fdp->ConsumeIntegral<int32_t>(), message);
                },
                [](FuzzedDataProvider* fdp, binder::Status*, Parcel*) -> void {
                    binder::Status::fromServiceSpecificError(fdp->ConsumeIntegral<int32_t>());
                },
                [](FuzzedDataProvider* fdp, binder::Status*, Parcel*) -> void {
                ...
                [](FuzzedDataProvider* fdp, binder::Status*, Parcel*) -> void {
                    binder::Status::fromStatusT(fdp->ConsumeIntegral<status_t>());
                },
                [](FuzzedDataProvider* fdp, binder::Status* status, Parcel*) -> void {
...
#endif // STATUS_FUZZER_FUNCTIONS_H_
