...
public:
    explicit RpcTransportRaw(android::RpcSocket socket) : mSocket(std::move(socket)) {}
...
public:
    std::unique_ptr<RpcTransport> newTransport(android::RpcSocket socket, FdTrigger*) const {
