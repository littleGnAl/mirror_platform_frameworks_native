...
std::unique_ptr<RpcTransport> newServerRpcTransportRaw(android::base::unique_fd acceptedFd) {
    return std::make_unique<RpcTransportRaw>(std::move(acceptedFd));
}

std::unique_ptr<RpcTransport> newClientRpcTransportRaw(android::base::unique_fd connectedFd) {
    return std::make_unique<RpcTransportRaw>(std::move(connectedFd));
}
