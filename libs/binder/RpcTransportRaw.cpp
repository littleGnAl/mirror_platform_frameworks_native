...
public:
    ...
    status_t interruptableReadOrWrite(FdTrigger* fdTrigger, iovec* iovs, size_t niovs,
        ...
        // we somehow advance past all the non-empty vectors and pass
        // some or all of the remaining zero-length vectors to sendmsg,
        ...
        // vector in iovs always has a non-zero length.
