...
// FIXME: document what this connection thing is
// FIXME: should this class be combined into RpcConnection, since we need to
// pass the connection to almost every method
class RpcState {
public:
