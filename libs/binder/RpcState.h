...
private:
    ...
    struct BinderNode {
        ...
        // Number of times we've sent this binder out of process, each time
        // corresponds to one incStrong/decStrong we hold on the binder object
        // on behalf of the remote process.
        size_t timesSent;
