 ...
 *         error code otherwise.
 */
int tipc_send2(handle_t chan, const void* hdr, size_t hdr_len, const void* payload,
               size_t payload_len);
 ...
 */
int tipc_recv2(handle_t chan, size_t min_sz, void* buf1, size_t buf1_sz, void* buf2,
               size_t buf2_sz);
 ...
 *         a negative error code otherwise.
 */
static inline int tipc_recv_hdr_payload(handle_t chan, void* hdr, size_t hdr_sz, void* payload,
                                        size_t payload_sz) {
 ...
 */
int tipc_hset_add_entry(struct tipc_hset* hset, handle_t handle, uint32_t evt_mask,
 ...
 * Return: 0 on success, a negative error code otherwise
 */
int tipc_hset_mod_entry(struct tipc_hset* hset, handle_t handle, uint32_t evt_mask,
                        struct tipc_event_handler* evt_handler);
