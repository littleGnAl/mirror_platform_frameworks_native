...
use tipc::{ConnectResult, Handle, MessageResult, PortCfg, Service, TipcError, Uuid};
...
impl Service for RpcServer {
    ...
    fn on_message(
        ...
        panic!("RpcServer::on_message called, should never happen");
    }

    fn on_message_unbuffered(
        &self,
