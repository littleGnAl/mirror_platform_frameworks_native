...
int main(void) {
    ...
    // tests: SendAndGetResultBackBig sends two strings of 1024 bytes each,
    // and we need a bit of extra space for the wire format.
    constexpr size_t max_msg_size = 64 + 2048;
    auto server =
