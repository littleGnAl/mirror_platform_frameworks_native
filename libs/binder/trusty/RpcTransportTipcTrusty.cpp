...
std::shared_ptr<RpcTransportCtx> RpcTransportCtxFactoryTipcTrusty::newServerCtx() const {
    return std::make_shared<RpcTransportCtxTipcTrusty>();
}

std::shared_ptr<RpcTransportCtx> RpcTransportCtxFactoryTipcTrusty::newClientCtx() const {
    return std::make_shared<RpcTransportCtxTipcTrusty>();
}
