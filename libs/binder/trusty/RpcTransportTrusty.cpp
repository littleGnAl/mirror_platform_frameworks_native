...
std::shared_ptr<RpcTransportCtxFactory> RpcTransportCtxFactoryTrusty::make() {
    return std::shared_ptr<RpcTransportCtxFactoryTrusty>(new RpcTransportCtxFactoryTrusty());
}
