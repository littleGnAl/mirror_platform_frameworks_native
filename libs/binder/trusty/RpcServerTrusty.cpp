...
status_t RpcServerTrusty::setupTrustyServer(tipc_hset* handleSet, const char* portName,
                                            const struct tipc_port_acl* acl, size_t msgMaxSize) {
    mTipcPort.name = portName;
