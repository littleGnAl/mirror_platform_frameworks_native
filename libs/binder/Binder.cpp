...
void BBinder::setRequestingSid(bool requestingSid)
{
    LOG_ALWAYS_FATAL_IF(wasSent(),
                        "setRequestingSid() should only be called before binder object is sent to "
                        "another process");
...
void BBinder::setMinSchedulerPolicy(int policy, int priority) {
    LOG_ALWAYS_FATAL_IF(wasSent(),
                        "setMinSchedulerPolicy() should only be called before binder object is sent to "
                        "another process");
...
void BBinder::setInheritRt(bool inheritRt) {
    LOG_ALWAYS_FATAL_IF(wasSent(),
                        "setInheritRt() should only be called before binder object is sent to "
                        "another process");
...
void BBinder::setExtension(const sp<IBinder>& extension) {
    LOG_ALWAYS_FATAL_IF(wasSent(),
                        "setExtension() should only be called before binder object is sent to "
                        "another process");
