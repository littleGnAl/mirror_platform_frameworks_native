...
bool ProcessState::isDriverFeatureEnabled(const DriverFeature feature) {
    static const char* const names[] = {
        [static_cast<int>(DriverFeature::ONEWAY_SPAM_DETECTION)] = "oneway_spam_detection",
        [static_cast<int>(DriverFeature::EXTENDED_ERROR)] = "extended_error",
    };
    std::string path = "/dev/binderfs/features/";
    std::ifstream fin (path.append(names[static_cast<int>(feature)]));
    char on;
    if (!fin) {
