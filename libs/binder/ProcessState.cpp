...
{
    return initWithDriver(kDefaultDriver);
}
...
sp<ProcessState> ProcessState::initWithDriver(const char* driver)
{
    ...
    LOG_ALWAYS_FATAL_IF(gProcess->getDriverName() != driver,
                        "ProcessState was already initialized with %s, can't"
                        " initialize with %s.", gProcess->getDriverName().c_str(),
                        driver);
