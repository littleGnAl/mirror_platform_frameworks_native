...
#ifndef BINDER_RPC_SINGLE_THREADED // This is an infinite loop in single-threaded mode
...
void RpcServer::establishConnection(sp<RpcServer>&& server, base::unique_fd clientFd,
    ...
    sp<RpcSession> session;
    {
        ...
        if (requestingNewSession) {
            ...
            session = sp<RpcSession>::make(std::shared_ptr(server->mCtx));
