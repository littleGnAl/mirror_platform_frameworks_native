...
public:
     ...
     * Server sessions will inherits this value from RpcServer. An incoming thread is a thread
     * which is serving a connection to a remote object. Each thread will serve a connection
     * to a remote object. These connections allow this RpcSession from the corresponding
     * RpcSession.
     *
