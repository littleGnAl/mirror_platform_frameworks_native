...
public:
    ...
    // FIXME: should be combined w/ creating root object/unix server.
    void join();

    // FIXME: this is only needed for test?
    const sp<RpcConnection>& getConnection() { return mConnection; }
...
private:
    ...
    // FIXME: support a list of connctions, each of these would correspond to a
    // different client/process/VM talking to this object
