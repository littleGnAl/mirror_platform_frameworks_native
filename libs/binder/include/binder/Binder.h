...
public:
    ...
    [[nodiscard]] status_t setRpcClient(android::base::unique_fd clientFd, uint32_t maxRpcThreads);
...
private:
    ...
    [[nodiscard]] status_t setRpcClient(const Parcel& data);
    [[nodiscard]] status_t setRpcMaxThreads(const Parcel& data);
