...
private:
    ...
    struct Summary {
        static inline Summary fromRepr(int32_t representation) {
            return *reinterpret_cast<Summary*>(&representation);
        }
        int32_t repr() const {
            return *reinterpret_cast<const int32_t*>(this);
        }
        static inline Summary currentFromLevel(Level level);
    ...
    static_assert(sizeof(Summary) == sizeof(int32_t));
