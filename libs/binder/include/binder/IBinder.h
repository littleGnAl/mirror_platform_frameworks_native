...
public:
     ...
     * a binder object is destructed, the cleanup function of all attached
     ...
     * - if you can, wait for the destructor to clean it up
     * - manually destruct the object (for instance by synchronizing all
     *   accesses to these APIs with your own lock and calling findObject
     *   before it is detached).
     *
     * non-virtual 'void* releaseObject(const void* objectID)' could be added
     * to this class if that usecase becomes common.
     */
