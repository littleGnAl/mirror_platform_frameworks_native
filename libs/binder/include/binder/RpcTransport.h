...
public:
    ...
    // True if TLS is enabled, false otherwise. For logging / debugging / testing only; caller
    // should not introduced behavioral changes based on this value.
    [[nodiscard]] virtual bool tlsEnabled() const = 0;
