...
public:
     ...
     */
    [[nodiscard]] bool setupInetServer(unsigned int port, unsigned int* assignedPort = nullptr);
...
private:
    ...
    bool setupSocketServer(const SocketAddress& address, unsigned int* assignedPort = nullptr);
