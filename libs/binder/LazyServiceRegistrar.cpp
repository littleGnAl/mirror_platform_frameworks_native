...
public:
    ...
    void setActiveServicesCountCallback(const std::function<bool(int)>& activeServicesCountCallback);
...
void ClientCounterCallback::setActiveServicesCountCallback(const std::function<bool(int)>& activeServicesCountCallback) {
...
void LazyServiceRegistrar::setActiveServicesCountCallback(const std::function<bool(int)>& activeServicesCountCallback) {
