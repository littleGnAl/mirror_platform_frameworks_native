...
std::shared_ptr<RpcTransportCtx> RpcTransportCtxFactoryTipcAndroid::newServerCtx() const {
    return std::make_shared<RpcTransportCtxTipcAndroid>();
}

std::shared_ptr<RpcTransportCtx> RpcTransportCtxFactoryTipcAndroid::newClientCtx() const {
    return std::make_shared<RpcTransportCtxTipcAndroid>();
}
