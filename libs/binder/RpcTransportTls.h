...
__attribute__((visibility("default"))) android::RpcTransportCtx *newServerRpcTransportCtxTls();

// Create a RpcTransport with TLS enabled. Return null on error.
// Caller takes ownership of returned object.
// Note: don't use directly. You probably want newClientRpcTransport.
__attribute__((visibility("default"))) android::RpcTransportCtx *newClientRpcTransportCtxTls();
} // extern "C"
