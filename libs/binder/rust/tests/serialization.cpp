...
int8_t TESTDATA_I8[4] = {-128, 0, 117, 127};
uint8_t TESTDATA_U8[4] = {0, 42, 117, 255};
char16_t TESTDATA_CHARS[4] = {0, 42, 117, numeric_limits<char16_t>::max()};
int32_t TESTDATA_I32[4] = {numeric_limits<int32_t>::min(), 0, 117, numeric_limits<int32_t>::max()};
int64_t TESTDATA_I64[4] = {numeric_limits<int64_t>::min(), 0, 117, numeric_limits<int64_t>::max()};
uint64_t TESTDATA_U64[4] = {0, 42, 117, numeric_limits<uint64_t>::max()};
float TESTDATA_FLOAT[4] = {
        numeric_limits<float>::quiet_NaN(),
        -numeric_limits<float>::infinity(),
        117.0,
        numeric_limits<float>::infinity(),
};
double TESTDATA_DOUBLE[4] = {
        numeric_limits<double>::quiet_NaN(),
        -numeric_limits<double>::infinity(),
        117.0,
        numeric_limits<double>::infinity(),
};
bool TESTDATA_BOOL[4] = {true, false, false, true};
const char* TESTDATA_STRS[4] = {"", nullptr, "test", ""};
