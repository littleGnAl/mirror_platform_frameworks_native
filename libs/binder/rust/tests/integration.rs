...
use binder::{
    Binder, IBinder, IBinderTransact, Interface, StatusCode, ThreadState, TransactionCode,
...
mod tests {
    ...
    use binder::{
        Binder, DeathRecipient, FromIBinder, IBinder, Interface, SpIBinder, StatusCode, Strong,
    };
