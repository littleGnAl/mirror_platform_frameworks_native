...
pub fn get_vsock_rpc_interface<T: FromIBinder + ?Sized>(
    ...
    interface_for_service(get_vsock_rpc_service(cid, port))
}
...
pub fn get_preconnected_rpc_interface<T: FromIBinder + ?Sized>(
    ...
    interface_for_service(get_preconnected_rpc_service(request_fd))
}

fn interface_for_service<T: FromIBinder + ?Sized>(
