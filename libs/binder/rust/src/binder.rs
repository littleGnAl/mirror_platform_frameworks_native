...
macro_rules! declare_binder_interface {
...

    {
        ...
        impl<P: $crate::binder_impl::BinderAsyncPool> $crate::binder_impl::ToAsyncInterface<P> for dyn $interface {
            type Target = dyn $async_interface<P>;
        }

        impl<P: $crate::binder_impl::BinderAsyncPool> $crate::binder_impl::ToSyncInterface for dyn $async_interface<P> {
