...
macro_rules! declare_binder_interface {
...

    {
        ...
        impl $crate::binder_impl::Remotable for $native {
            ...
            fn on_transact(&self, code: $crate::binder_impl::TransactionCode, data: &$crate::binder_impl::Parcel, reply: &mut $crate::binder_impl::Parcel) -> std::result::Result<(), $crate::StatusCode> {
        ...
        {
            fn serialize(&self, parcel: &mut $crate::binder_impl::Parcel) -> std::result::Result<(), $crate::StatusCode> {
        ...
        impl $crate::binder_impl::SerializeOption for dyn $interface + '_ {
            fn serialize_option(this: Option<&Self>, parcel: &mut $crate::binder_impl::Parcel) -> std::result::Result<(), $crate::StatusCode> {
        ...
        impl<P: $crate::binder_impl::BinderAsyncPool> $crate::FromIBinder for dyn $async_interface<P> {
        ...
        impl<P: $crate::binder_impl::BinderAsyncPool> $crate::binder_impl::Serialize for dyn $async_interface<P> + '_ {
            fn serialize(&self, parcel: &mut $crate::binder_impl::Parcel) -> std::result::Result<(), $crate::StatusCode> {
                let binder = $crate::Interface::as_binder(self);
                parcel.write(&binder)
            }
        ...
        impl<P: $crate::binder_impl::BinderAsyncPool> $crate::binder_impl::SerializeOption for dyn $async_interface<P> + '_ {
            fn serialize_option(this: Option<&Self>, parcel: &mut $crate::binder_impl::Parcel) -> std::result::Result<(), $crate::StatusCode> {
                parcel.write(&this.map($crate::Interface::as_binder))
            }
        }

        impl<P: $crate::binder_impl::BinderAsyncPool> std::fmt::Debug for dyn $async_interface<P> + '_ {
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        ...
        impl<P: $crate::binder_impl::BinderAsyncPool> std::borrow::ToOwned for dyn $async_interface<P> {
...
macro_rules! declare_binder_enum {
    {
        ...
        impl $crate::binder_impl::SerializeArray for $enum {
            fn serialize_array(slice: &[Self], parcel: &mut $crate::binder_impl::Parcel) -> std::result::Result<(), $crate::StatusCode> {
        ...
        impl $crate::binder_impl::Deserialize for $enum {
            fn deserialize(parcel: &$crate::binder_impl::Parcel) -> std::result::Result<Self, $crate::StatusCode> {
                parcel.read().map(Self)
            }
        }

        impl $crate::binder_impl::DeserializeArray for $enum {
            fn deserialize_array(parcel: &$crate::binder_impl::Parcel) -> std::result::Result<Option<Vec<Self>>, $crate::StatusCode> {
