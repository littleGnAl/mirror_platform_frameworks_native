...
macro_rules! declare_binder_interface {
...

    {
        ...
        impl $crate::binder_impl::Remotable for $native {
            ...
            fn on_transact(&self, code: $crate::binder_impl::TransactionCode, data: &$crate::binder_impl::Parcel, reply: &mut $crate::binder_impl::Parcel) -> Result<(), $crate::StatusCode> {
        ...
        impl $crate::binder_impl::FromIBinder for dyn $interface {
            fn try_from(mut ibinder: $crate::SpIBinder) -> Result<$crate::Strong<dyn $interface>, $crate::StatusCode> {
                ...
                if ibinder.associate_class(<$native as $crate::binder_impl::Remotable>::get_class()) {
                    let service: Result<$crate::binder_impl::Binder<$native>, $crate::StatusCode> =
        ...
        {
            fn serialize(&self, parcel: &mut $crate::binder_impl::Parcel) -> Result<(), $crate::StatusCode> {
        ...
        impl $crate::binder_impl::SerializeOption for dyn $interface + '_ {
            fn serialize_option(this: Option<&Self>, parcel: &mut $crate::binder_impl::Parcel) -> Result<(), $crate::StatusCode> {
...
macro_rules! declare_binder_enum {
    {
        ...
        impl $crate::binder_impl::SerializeArray for $enum {
            fn serialize_array(slice: &[Self], parcel: &mut $crate::binder_impl::Parcel) -> Result<(), $crate::StatusCode> {
        ...
        impl $crate::binder_impl::Deserialize for $enum {
            fn deserialize(parcel: &$crate::binder_impl::Parcel) -> Result<Self, $crate::StatusCode> {
                parcel.read().map(Self)
            }
        }

        impl $crate::binder_impl::DeserializeArray for $enum {
            fn deserialize_array(parcel: &$crate::binder_impl::Parcel) -> Result<Option<Vec<Self>>, $crate::StatusCode> {
