...
extern "C" {
    ...
    #[doc = " an AStatus instance."]
    #[doc = ""]
    #[doc = " Available since API level 29."]
    #[doc = ""]
    #[doc = " \\param a low-level error to associate with this status object."]
    #[doc = ""]
    #[doc = " \\return a newly constructed status object that the caller owns."]
...
extern "C" {
    ...
    #[doc = " sanity checks on transactions."]
...
extern "C" {
    ...
    #[doc = " Available since API level 29."]
    #[doc = ""]
    #[doc = " \\param dump function to call when an instance of this binder class is being dumped."]
...
extern "C" {
    ...
    #[doc = " be given (since if the local process dies, then no recipient will exist to recieve a"]
    #[doc = " transaction). The cookie is passed to recipient in the case that this binder dies and can be"]
    #[doc = " null. The exact cookie must also be used to unlink this transaction (see AIBinder_linkToDeath)."]
...
extern "C" {
    #[doc = " Creates a parcel to start filling out for a transaction. This may add data to the parcel for"]
    #[doc = " security, debugging, or other purposes. This parcel is to be sent via AIBinder_transact and it"]
    #[doc = " represents the input data to the transaction. It is recommended to check if the object is local"]
    #[doc = " and call directly into its user data before calling this as the parceling and unparceling cost"]
    #[doc = " can be avoided. This AIBinder must be either built with a class or associated with a class before"]
    #[doc = " using this API."]
    #[doc = ""]
...
pub const FIRST_CALL_TRANSACTION: android_c_interface__bindgen_ty_1 = 1;
pub const LAST_CALL_TRANSACTION: android_c_interface__bindgen_ty_1 = 16777215;
pub type android_c_interface__bindgen_ty_1 = u32;
pub const FLAG_ONEWAY: android_c_interface__bindgen_ty_2 = 1;
pub type android_c_interface__bindgen_ty_2 = u32;
#[repr(C)]
#[derive(Copy, Clone)]
