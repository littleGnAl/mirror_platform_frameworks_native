...
pub struct android_BBinder {
    pub _base: android_IBinder,
    pub mExtras: u64,
    pub __bindgen_anon_1: android_BBinder__bindgen_ty_1,
}
#[repr(C)]
#[derive(Copy, Clone)]
...
fn bindgen_test_layout_android_BBinder() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<android_BBinder>())).mExtras as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(android_BBinder),
            "::",
            stringify!(mExtras)
        )
    );
...
#[repr(C)]
#[derive(Copy, Clone)]
pub struct android_c_interface_BinderNative {
    _unused: [u8; 0],
}
...
>;
extern "C" {
    #[link_name = "\u{1}_ZN7android11c_interface15NewBinderNativeEP10RustObjectPKNS_8String16EPFiS2_jPKNS_6ParcelEPS6_jE"]
    pub fn android_c_interface_NewBinderNative(
        object: *mut RustObject,
        descriptor: *const android_String16,
        transactCallback: android_c_interface_TransactCallback,
    ) -> *mut android_sp<android_c_interface_BinderNative>;
}
extern "C" {
    #[link_name = "\u{1}_ZN7android11c_interface26BinderNative_writeToParcelEPNS_2spINS0_12BinderNativeEEEPNS_6ParcelE"]
    pub fn android_c_interface_BinderNative_writeToParcel(
        binder: *mut android_sp<android_c_interface_BinderNative>,
        parcel: *mut android_Parcel,
    ) -> android_status_t;
}
extern "C" {
...
extern "C" {
    #[link_name = "\u{1}_ZN7android11c_interface14GetThreadStateEv"]
    pub fn android_c_interface_GetThreadState() -> *mut android_IPCThreadState;
}
extern "C" {
...
extern "C" {
    #[link_name = "\u{1}_ZN7android11c_interface30IBinder_getInterfaceDescriptorEPNS_7IBinderE"]
...
#[test]
fn __bindgen_test_layout_android_sp_open0_android_IInterface_close0_instantiation_2() {
    assert_eq!(
        ::std::mem::size_of::<android_sp<android_IInterface>>(),
        8usize,
        concat!(
