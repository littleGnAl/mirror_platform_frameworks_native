...
impl Parcel {
    ...
    pub unsafe fn write_interface_token(&mut self, interface: &String16) -> BinderResult<()> {
        binder_status(android_Parcel_writeInterfaceToken(self.ptr, interface.0))
    }
    ...
    pub unsafe fn enforce_interface(
        ...
        android_Parcel_enforceInterface(self.ptr, interface.0, threadState)
    }
    ...
    pub fn write_string8(&mut self, str: &String8) -> BinderResult<()> {
        unsafe { binder_status(android_Parcel_writeString8(self.ptr, &str.0)) }
    }

    pub fn write_string16(&mut self, str: &String16) -> BinderResult<()> {
        unsafe { binder_status(android_Parcel_writeString16(self.ptr, str.0)) }
    }
    ...
    pub fn write_binder_native<T: Binder>(
        &mut self,
        binder: &BinderNative<T>,
    ) -> BinderResult<()> {
        binder.writeToParcel(self)
    }

    // pub(crate) fn write_binder(&mut self, binder: &IBinder) -> BinderResult<()> {
    //     unsafe {
    ...
    pub fn write_i8_slice(&mut self, slice: &[i8]) -> BinderResult<()> {
        ...
        unsafe {
            binder_status(android_Parcel_writeByteArray(self.ptr, len, slice.as_ptr() as *const u8))
        }
    }
    ...
    pub fn write_u16_slice(&mut self, slice: &[u16]) -> BinderResult<()> {
        ...
        unsafe {
            binder_status(android_Parcel_writeByteArray(self.ptr, byte_len, slice.as_ptr() as *const u8))
        }
    }
    ...
    pub unsafe fn write_unique_file_descriptor(&mut self, fd: RawFd) -> BinderResult<()> {
        ...
        binder_status(android_Parcel_writeUniqueFileDescriptor(self.ptr, &fd))
    }
    ...
    pub fn write_blob(&mut self, len: size_t, mutableCopy: bool) -> BinderResult<Blob<Writable>> {
        ...
        let status =
            unsafe { android_Parcel_writeBlob(self.ptr, len, mutableCopy, blob.as_mut_ptr()) };
    ...
    pub fn read_string8(&self) -> String8 {
        ...
        // android_Parcel_readString8(self.ptr)
    ...
    pub fn try_read_string8(&self) -> BinderResult<String8> {
        ...
        let result = unsafe { android_Parcel_readString81(self.ptr, &mut string8.0) };
    ...
    pub fn try_read_string16(&self) -> BinderResult<String16> {
        ...
        binder_status(status).map(|_| unsafe { String16(s.assume_init()) })
    }
    ...
    //     // writes to a parameter. See
    //     // https://github.com/rust-lang/rust-bindgen/issues/778
    //     // android_Parcel_readStrongBinder(self.ptr, &mut sp_binder)
    ...
    //     let status = android_Parcel_readStrongBinder1(self.ptr, sp_binder.as_native_mut());
    ...
    pub unsafe fn read_unique_file_descriptor(&self) -> BinderResult<RawFd> {
        ...
        let status = android_Parcel_readUniqueFileDescriptor(self.ptr, fd.as_mut_ptr());
    ...
    pub unsafe fn read_unique_parcel_file_descriptor(&self) -> BinderResult<RawFd> {
        let mut fd = MaybeUninit::uninit();
        let status = android_Parcel_readUniqueParcelFileDescriptor(self.ptr, fd.as_mut_ptr());
    ...
    pub fn read_blob(&self, len: size_t) -> BinderResult<Blob<Readable>> {
        let mut blob = MaybeUninit::uninit();
        let status = unsafe { android_Parcel_readBlob(self.ptr, len, blob.as_mut_ptr()) };
