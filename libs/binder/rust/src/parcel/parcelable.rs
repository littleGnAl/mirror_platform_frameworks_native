...
pub trait Deserialize: Sized {
    ...
    /// of the current object. This operation will overwrite the current
    /// value partially or completely, depending on the available data.
...
pub trait DeserializeOption: Deserialize {
    ...
    /// This operation will overwrite the current value partially or
    /// completely, depending on the available data.
