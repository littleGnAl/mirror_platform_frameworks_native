...
pub use crate::binder::{
    CloneInterface, FromIBinder, IBinder, Interface, InterfaceClass, Remotable, TransactionCode, TransactionFlags,
};
...
pub mod public_api {
    ...
    pub use super::{
        CloneInterface, ExceptionCode, Interface, ProcessState, SpIBinder, Status, StatusCode,
    };
