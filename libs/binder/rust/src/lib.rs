...
pub use parcel::ParcelFileDescriptor;
pub use proxy::{get_interface, get_service, wait_for_interface, wait_for_service, DeathRecipient, SpIBinder, WpIBinder};
...
/// Internal API for use by the AIDL compiler.
#[doc(hidden)]
pub mod aidl_internal_api {
    pub use crate::binder::{
        FromIBinder, IBinderInternal, InterfaceClass, Remotable, Stability, TransactionCode,
        TransactionFlags, FIRST_CALL_TRANSACTION, FLAG_CLEAR_BUF, FLAG_ONEWAY, FLAG_PRIVATE_LOCAL,
        LAST_CALL_TRANSACTION,
    };
    pub use crate::error::status_t;
    pub use crate::native::Binder;
    pub use crate::parcel::{
        Deserialize, DeserializeArray, DeserializeOption, Parcel, Serialize, SerializeArray, SerializeOption,
    };
