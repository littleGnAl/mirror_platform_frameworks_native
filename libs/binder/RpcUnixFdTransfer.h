...
static inline status_t SendFdOverUnixSocket(const base::unique_fd& transportFd,
                                            base::unique_fd sendFd) {
...
static inline status_t RecvFdOverUnixSocket(const base::unique_fd& transportFd,
