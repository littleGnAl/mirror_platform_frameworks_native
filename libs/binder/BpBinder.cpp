...
const String16& BpBinder::getInterfaceDescriptor() const
{
    if (isDescriptorCached() == false) {
        sp<BpBinder> thiz = sp<BpBinder>::assertStrongRefExists(const_cast<BpBinder*>(this));
...
{
    Parcel data;
    data.markForBinder(sp<BpBinder>::assertStrongRefExists(this));
    Parcel reply;
...
void BpBinder::reportOneDeath(const Obituary& obit)
{
    ...
    recipient->binderDied(wp<BpBinder>::assertWeakRefExists(this));
}
