...
// Starts a Unix domain RPC server with the given socket file pathname and
// a given root IBinder object.
// This function sets up the server, calls readyCallback with a given param, and
// then joins before returning.
bool RunUnixDomainRpcServer(AIBinder* service, const char* pathname, void (*readyCallback)(void* param), void* param);
