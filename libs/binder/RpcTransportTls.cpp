...
Result<ssize_t> RpcTransportTls::send(const void *buf, int size) {
    while (true) {
...
Result<ssize_t> RpcTransportTls::recv(void *buf, int size) {
    while (true) {
...
Result<ssize_t> RpcTransportTls::peek(void *buf, int size) {
    while (true) {
