...
status_t RpcTransportTls::interruptableWriteFully(FdTrigger* fdTrigger, IoVecList iovs,
                                                  const std::function<status_t()>& altPoll) {
...
status_t RpcTransportTls::interruptableReadFully(FdTrigger* fdTrigger, IoVecList iovs,
                                                 const std::function<status_t()>& altPoll) {
    MAYBE_WAIT_IN_FLAKE_MODE;
