...
class RpcTransportCtxTlsServer;
class RpcTransportCtxTlsClient;
...
private:
    friend RpcTransportCtxTlsServer;
    friend RpcTransportCtxTlsClient;
...
std::unique_ptr<RpcTransportCtxTlsServer> RpcTransportCtxTlsServer::create() {
    ...
    auto rpcTransportTlsServerCtx =
            std::unique_ptr<RpcTransportCtxTlsServer>(new RpcTransportCtxTlsServer());
...
std::unique_ptr<RpcTransportCtxTlsClient> RpcTransportCtxTlsClient::create() {
    ...
    auto rpcTransportTlsClientCtx =
            std::unique_ptr<RpcTransportCtxTlsClient>(new RpcTransportCtxTlsClient());
...
android::RpcTransportCtx *newServerRpcTransportCtxTls() {
    return android::RpcTransportCtxTlsServer::create().release();
}

android::RpcTransportCtx *newClientRpcTransportCtxTls() {
    return android::RpcTransportCtxTlsClient::create().release();
}
