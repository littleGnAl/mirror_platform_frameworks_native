...
void APersistableBundle_putStringVector(APersistableBundle* pBundle, const char* key,
                                        const char* const* vec, size_t num) {
...
ssize_t APersistableBundle_getString(const APersistableBundle* pBundle, const char* key, char** val,
                                     bool (*strDupAllocator)(char**, size_t, const char*)) {
    android::String16 outVal;
    bool ret = pBundle->mPBundle.getString(android::String16(key), &outVal);
    if (ret) {
        char* out;
        android::String8 tmp8(outVal);
        bool ret = strDupAllocator(&out, tmp8.bytes(), tmp8.c_str());
        if (ret) {
            *val = out;
            return tmp8.bytes();
        } else {
...
size_t APersistableBundle_getBooleanVector(const APersistableBundle* pBundle, const char* key,
                                           bool* buffer, size_t bufferSizeBytes) {
...
size_t APersistableBundle_getIntVector(const APersistableBundle* pBundle, const char* key,
                                       int32_t* buffer, size_t bufferSizeBytes) {
...
size_t APersistableBundle_getLongVector(const APersistableBundle* pBundle, const char* key,
                                        int64_t* buffer, size_t bufferSizeBytes) {
...
size_t APersistableBundle_getDoubleVector(const APersistableBundle* pBundle, const char* key,
                                          double* buffer, size_t bufferSizeBytes) {
...
ssize_t APersistableBundle_getStringVector(const APersistableBundle* pBundle, const char* key,
                                           char** vec, size_t bufferSizeBytes,
                                           bool (*strDupAllocator)(char**, size_t, const char*)) {
...
ssize_t APersistableBundle_getBooleanKeys(const APersistableBundle* pBundle, char** outKeys,
...
ssize_t APersistableBundle_getIntKeys(const APersistableBundle* pBundle, char** outKeys,
                                      size_t bufferSizeBytes,
                                      bool (*strDupAllocator)(char**, size_t, const char*)) {
...
ssize_t APersistableBundle_getLongKeys(const APersistableBundle* pBundle, char** outKeys,
                                       size_t bufferSizeBytes,
                                       bool (*strDupAllocator)(char**, size_t, const char*)) {
...
ssize_t APersistableBundle_getDoubleKeys(const APersistableBundle* pBundle, char** outKeys,
                                         size_t bufferSizeBytes,
                                         bool (*strDupAllocator)(char**, size_t, const char*)) {
...
ssize_t APersistableBundle_getStringKeys(const APersistableBundle* pBundle, char** outKeys,
                                         size_t bufferSizeBytes,
                                         bool (*strDupAllocator)(char**, size_t, const char*)) {
...
ssize_t APersistableBundle_getBooleanVectorKeys(const APersistableBundle* pBundle, char** outKeys,
                                                size_t bufferSizeBytes,
                                                bool (*strDupAllocator)(char**, size_t,
                                                                        const char*)) {
    std::set<android::String16> ret = pBundle->mPBundle.getBooleanVectorKeys();
    return getStringsInternal<std::set<android::String16>>(ret, outKeys, bufferSizeBytes,
                                                           strDupAllocator);
}
ssize_t APersistableBundle_getIntVectorKeys(const APersistableBundle* pBundle, char** outKeys,
                                            size_t bufferSizeBytes,
                                            bool (*strDupAllocator)(char**, size_t, const char*)) {
...
ssize_t APersistableBundle_getLongVectorKeys(const APersistableBundle* pBundle, char** outKeys,
                                             size_t bufferSizeBytes,
                                             bool (*strDupAllocator)(char**, size_t, const char*)) {
...
ssize_t APersistableBundle_getDoubleVectorKeys(const APersistableBundle* pBundle, char** outKeys,
                                               size_t bufferSizeBytes,
                                               bool (*strDupAllocator)(char**, size_t,
                                                                       const char*)) {
...
ssize_t APersistableBundle_getStringVectorKeys(const APersistableBundle* pBundle, char** outKeys,
                                               size_t bufferSizeBytes,
                                               bool (*strDupAllocator)(char**, size_t,
                                                                       const char*)) {
...
ssize_t APersistableBundle_getPersistableBundleKeys(const APersistableBundle* pBundle,
                                                    char** outKeys, size_t bufferSizeBytes,
                                                    bool (*strDupAllocator)(char**, size_t,
                                                                            const char*)) {
