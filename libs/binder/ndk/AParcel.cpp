...
AParcel* AParcel_new() {
    return new AParcel(new Parcel, true /*owns*/);
}
...
binder_status_t AParcel_writeStrongBinder(AParcel* parcel, const AIBinder* binder) {
    return (*parcel)->writeStrongBinder(binder->getBinder());
}
binder_status_t AParcel_readStrongBinder(AParcel* parcel, AIBinder** binder) {
    sp<IBinder> remoteBinder = nullptr;
    binder_status_t status = (*parcel)->readStrongBinder(&remoteBinder);
    if (status != EX_NONE) {
        return status;
    }
...
binder_status_t AParcel_readInt32(AParcel* parcel, int32_t* value) {
    return (*parcel)->readInt32(value);
}
binder_status_t AParcel_readUint32(AParcel* parcel, uint32_t* value) {
    return (*parcel)->readUint32(value);
}
binder_status_t AParcel_readInt64(AParcel* parcel, int64_t* value) {
    return (*parcel)->readInt64(value);
}
binder_status_t AParcel_readUint64(AParcel* parcel, uint64_t* value) {
    return (*parcel)->readUint64(value);
}
binder_status_t AParcel_readFloat(AParcel* parcel, float* value) {
    return (*parcel)->readFloat(value);
}
binder_status_t AParcel_readDouble(AParcel* parcel, double* value) {
    return (*parcel)->readDouble(value);
}
binder_status_t AParcel_readBool(AParcel* parcel, bool* value) {
    return (*parcel)->readBool(value);
}
binder_status_t AParcel_readChar(AParcel* parcel, char16_t* value) {
    return (*parcel)->readChar(value);
}
binder_status_t AParcel_readByte(AParcel* parcel, int8_t* value) {
