...
binder_status_t IFoo_Class_onTransact(transaction_code_t code, AIBinder* binder, AParcel* in,
                                      AParcel* out) {
    binder_status_t stat = EX_NONE;
...
AIBinder_Class* kIFoo_Class = AIBinder_Class_define("my-special-IFoo-class", IFoo_Class_onCreate,
