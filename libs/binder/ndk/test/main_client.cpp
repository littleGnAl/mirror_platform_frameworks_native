...
// FIXME: I'm planning on fixing this using findObject/detachObject on IBinder
// TEST(NdkBinder, SameRemoteObjectIsSameRemoteObject) {
//     sp<IFoo> foo1 = IFoo::getService(IFoo::kSomeInstanceName);
//     sp<IFoo> foo2 = IFoo::getService(IFoo::kSomeInstanceName);
//     EXPECT_EQ(foo1.get(), foo2.get());
// }

TEST(NdkBinder, RetrieveNonNdkService) {
    AIBinder* binder = AIBinder_getService(kExistingNonNdkService);
