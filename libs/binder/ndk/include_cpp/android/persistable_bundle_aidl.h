...
class PersistableBundle {
   public:
    ...
    static char* _Nullable stringAllocator(size_t bufferSizeBytes, void* _Nullable) {
    ...
    std::set<std::string> getKeys(
            ssize_t (*_Nonnull getTypedKeys)(const APersistableBundle* _Nonnull pBundle,
        ...
        // call first with nullptr to get required size in bytes
        ssize_t bytes = getTypedKeys(pBundle, nullptr, 0, &stringAllocator, nullptr);
        if (bytes > 0) {
