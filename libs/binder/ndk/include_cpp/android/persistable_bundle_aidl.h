...
class PersistableBundle {
   public:
    ...
    static bool strDupAllocator(char* _Nullable* _Nonnull outStr, size_t bufferSizeBytes,
    ...
    template <typename T>
    bool getVecInternal(size_t (*_Nonnull getVec)(const APersistableBundle* _Nonnull,
                                                  const char* _Nonnull, T* _Nullable, size_t),
    ...
    template <typename T>
    T moveStringsInternal(char* _Nullable* _Nonnull strings, size_t bufferSizeBytes) {
    ...
    std::set<std::string> getKeys(
            ssize_t (*_Nonnull getTypedKeys)(
                    const APersistableBundle* _Nonnull pBundle, char* _Nullable* _Nullable outKeys,
                    size_t bufferSizeBytes,
                    bool (*_Nonnull strDupAllocator)(char* _Nullable* _Nullable, size_t,
                                                     const char* _Nonnull)),
