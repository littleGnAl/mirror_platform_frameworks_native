...
typedef struct AWeak_AIBinder AWeak_AIBinder;
...
__attribute__((warn_unused_result)) AWeak_AIBinder* AWeak_AIBinder_new(AIBinder* binder);
 ...
 */
__attribute__((warn_unused_result)) AIBinder* AWeak_AIBinder_promote(AWeak_AIBinder* weakBinder);
