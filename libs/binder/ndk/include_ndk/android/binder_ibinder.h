 ...
 * sanity checks on transactions. \param onCreate see AIBinder_Class_onCreate. \param onDestroy see
 * AIBinder_Class_onDestroy. \param onTransact see AIBinder_Class_onTransact.
 *
