 ...
 *
 * This only ever needs to be called when the AIBinder_DeathRecipient remains. If this object is
 * deleted, all binders will automatically be unlinked.
 *
 ...
 *         If the service is already dead, this will return STATUS_DEAD_OBJECT.
 */
