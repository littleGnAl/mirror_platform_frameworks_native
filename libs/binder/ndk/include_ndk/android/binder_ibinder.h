 ...
 *
 * This only ever needs to be called when the AIBinder_DeathRecipient remains. If the death
 * recipient is deleted, all binders will automatically be unlinked. If the binder dies, it will
 * automatically unlink. If the AIBinder is deleted but the AIBinder_DeathRecipient remains, this
 * will leak.
 *
