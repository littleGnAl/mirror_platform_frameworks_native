 ...
 */
template <typename T>
static inline T* AParcel_std_vector_getter(void* vectorData) {
    std::vector<T>* vec = static_cast<std::vector<T>*>(vectorData);
    return vec->data();
}
 ...
 */
template <typename T>
static inline T AParcel_std_vector_getter(const void* vectorData, size_t index) {
 ...
 */
template <typename T>
static inline void AParcel_std_vector_setter(void* vectorData, size_t index, T value) {
    std::vector<T>* vec = static_cast<std::vector<T>*>(vectorData);
    (*vec)[index] = value;
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<int32_t>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<int32_t>(const AParcel* parcel,
                                                          std::vector<int32_t>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readInt32Array(parcel, &vectorData, &AParcel_std_vector_reallocator<int32_t>,
                                  AParcel_std_vector_getter<int32_t>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<uint32_t>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<uint32_t>(const AParcel* parcel,
                                                           std::vector<uint32_t>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readUint32Array(parcel, &vectorData, &AParcel_std_vector_reallocator<uint32_t>,
                                   AParcel_std_vector_getter<uint32_t>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<int64_t>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<int64_t>(const AParcel* parcel,
                                                          std::vector<int64_t>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readInt64Array(parcel, &vectorData, &AParcel_std_vector_reallocator<int64_t>,
                                  AParcel_std_vector_getter<int64_t>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<uint64_t>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<uint64_t>(const AParcel* parcel,
                                                           std::vector<uint64_t>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readUint64Array(parcel, &vectorData, &AParcel_std_vector_reallocator<uint64_t>,
                                   AParcel_std_vector_getter<uint64_t>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<float>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<float>(const AParcel* parcel,
                                                        std::vector<float>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readFloatArray(parcel, &vectorData, &AParcel_std_vector_reallocator<float>,
                                  AParcel_std_vector_getter<float>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<double>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<double>(const AParcel* parcel,
                                                         std::vector<double>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readDoubleArray(parcel, &vectorData, &AParcel_std_vector_reallocator<double>,
                                   AParcel_std_vector_getter<double>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<bool>(AParcel* parcel,
                                                        const std::vector<bool>& vec) {
    return AParcel_writeBoolArray(parcel, static_cast<const void*>(&vec),
                                  AParcel_std_vector_getter<bool>, vec.size());
}
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<bool>(const AParcel* parcel,
                                                       std::vector<bool>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readBoolArray(parcel, &vectorData, &AParcel_std_vector_reallocator<bool>,
                                 AParcel_std_vector_setter<bool>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<char16_t>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<char16_t>(const AParcel* parcel,
                                                           std::vector<char16_t>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readCharArray(parcel, &vectorData, &AParcel_std_vector_reallocator<char16_t>,
                                 AParcel_std_vector_getter<char16_t>);
}
 ...
 */
template <>
static inline binder_status_t AParcel_writeVector<int8_t>(AParcel* parcel,
 ...
 */
template <>
static inline binder_status_t AParcel_readVector<int8_t>(const AParcel* parcel,
                                                         std::vector<int8_t>* vec) {
    void* vectorData = static_cast<void*>(vec);
    return AParcel_readByteArray(parcel, &vectorData, &AParcel_std_vector_reallocator<int8_t>,
                                 AParcel_std_vector_getter<int8_t>);
}
