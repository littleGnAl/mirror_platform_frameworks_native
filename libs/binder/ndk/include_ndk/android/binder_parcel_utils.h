 ...
 */
static inline binder_status_t AParcel_writeInt32Array(AParcel* parcel, std::vector<int32_t>* vec) {
 ...
 */
static inline binder_status_t AParcel_writeInt64Array(AParcel* parcel, std::vector<int64_t>* vec) {
 ...
 */
static inline binder_status_t AParcel_writeFloatArray(AParcel* parcel, std::vector<float>* vec) {
 ...
 */
static inline binder_status_t AParcel_writeDoubleArray(AParcel* parcel, std::vector<double>* vec) {
 ...
 */
static inline bool AParcel_bool_std_vector_getter(void* vectorData, size_t index) {
 ...
 */
static inline binder_status_t AParcel_writeBoolArray(AParcel* parcel, std::vector<bool>* vec) {
    return AParcel_writeBoolArray(parcel, static_cast<void*>(vec), AParcel_bool_std_vector_getter,
                                  vec->size());
}
 ...
 */
static inline binder_status_t AParcel_writeCharArray(AParcel* parcel, std::vector<char16_t>* vec) {
 ...
 */
static inline binder_status_t AParcel_writeByteArray(AParcel* parcel, std::vector<int8_t>* vec) {
