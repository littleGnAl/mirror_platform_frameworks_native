 ...
 *
 * \param outStr pointer to a char* to fill in with the duplicated string
 * \param sizeBytes size of the inStr in bytes
 * \param inStr the string to duplicate
 *
 ...
 * a new copy of the stored APersistableBundle
 *
 * \return true if a value exists for the provided key
 */
