...
void APersistableBundle_putBooleanVector(APersistableBundle* _Nonnull pBundle) __INTRODUCED_IN(35);
...
bool APersistableBundle_getString(const APersistableBundle* _Nonnull pBundle,
        ...
        __INTRODUCED_IN(35);
void APersistableBundle_getBooleanVector(const APersistableBundle* _Nonnull pBundle)
        __INTRODUCED_IN(35);
