 ...
 * APersistableBundle exists to be used in AIDL interfaces and seemlessly
 ...
 */
typedef char* _Nullable (*_Nonnull APersistableBundle_stringAllocator)(size_t sizeBytes,
...
ssize_t APersistableBundle_getPersistableBundleKeys(
        ...
        size_t bufferSizeBytes, APersistableBundle_stringAllocator stringAllocator,
        void* _Nullable context) __INTRODUCED_IN(__ANDROID_API_V__);
