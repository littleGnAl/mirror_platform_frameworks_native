 ...
 * null-terminator). If the object at this index is 'null', then this should be set to -1.
 *
 * \param a null-terminated buffer of size 'outLength + 1' representing the string at the provided
 * index including the null-terminator. If the object at index is null, then this should be nullptr.
 */
