 ...
 * \param length the length of the buffer needed to fill (not including the null-terminator)
 *
 * \return a buffer of length length + 1 or null if allocation failed.
 */
 ...
 * AParcel_stringAllocator. This does not include the length required for a null-terminator.
 *
 * \return a buffer of length length + 1 or null if allocation failed.
 */
 ...
 * \param arrayData some external representation of an array.
 * \param index the index at which a string should be allocated.
 * \param length an out parameter for the length of the string (not including the null-terminator)
 *
 * \param a null-terminated buffer of length length + 1 representing the string at the provided
 * index.
 */
 ...
 *
 * \return a buffer of int32_t of length length.
 */
 ...
 * \param length the length to allocate arrayData to.
 *
 * \return a buffer of uint32_t of length length.
 */
 ...
 * \param length the length to allocate arrayData to.
 *
 * \return a buffer of int64_t of length length.
 */
 ...
 * \param length the length to allocate arrayData to.
 *
 * \return a buffer of uint64_t of length length.
 */
 ...
 * \param length the length to allocate arrayData to.
 *
 * \return a buffer of float of length length.
 */
 ...
 * \param length the length to allocate arrayData to.
 *
 * \return a buffer of double of length length.
 */
 ...
 * \param length the length to allocate arrayData to.
 *
 * \return a buffer of char16_t of length length.
 */
 ...
 * \param length the length to allocate arrayData to.
 *
 * \return a buffer of int8_t of length length.
 */
 ...
 * terminator should be of length length + 1. \param length the length of the string to be written.
 *
 * \return STATUS_OK on successful write.
 */
 ...
 * \param parcel the parcel to read from.
 * \param arrayData some external representation of an array.
 * \param allocator the callback which will be called with arrayData once the size of the output
 * array is known. \param elementAllocator the callback which will be called on every index of
 * arrayData to allocate the string at that location.
 *
 ...
 *
 * \param parcel the parcel to write to.
 * \param arrayData an array of length length.
 ...
 * \param parcel the parcel to read from.
 * \param arrayData some external representation of an array.
 * \param allocator the callback which will be called to allocate the array.
 *
 * \return STATUS_OK on successful read.
 */
 ...
 * \param arrayData some external representation of an array.
 * \param allocator the callback which will be called to allocate the array.
 * \param setter the callback which will be called to set a value at a specific location in the
 * array.
 *
 * \return STATUS_OK on successful read.
 */
