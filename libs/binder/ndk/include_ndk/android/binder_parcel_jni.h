 ...
 * \param parcel android.os.Parcel java object. This must be deleted with
 * AParcel_delete. This does not take ownership of the jobject and is only
 * good for as long as the jobject is alive.
 *
