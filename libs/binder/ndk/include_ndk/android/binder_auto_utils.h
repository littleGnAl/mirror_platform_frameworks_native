...
public:
    ...
    // This allows the value in this class to be set from beneath it. If you call this method and then
    // change the value of T*, you must take ownership of the value you are replacing.
    //
