 ...
 */
class SpAIBinder_DeathRecipient
      : public ScopedA<AIBinder_DeathRecipient, AIBinder_DeathRecipient_delete> {
public:
    /**
     * Takes ownership of a.
     */
    explicit SpAIBinder_DeathRecipient(AIBinder_DeathRecipient* a = nullptr) : ScopedA(a) {}
    ~SpAIBinder_DeathRecipient() {}
    SpAIBinder_DeathRecipient(SpAIBinder_DeathRecipient&&) = default;
};

/**
 * Convenience wrapper. See AIBinder_Weak.
 */
class SpAIBinder_Weak : public ScopedA<AIBinder_Weak, AIBinder_Weak_delete> {
public:
    /**
     * Takes ownership of a.
     */
    explicit SpAIBinder_Weak(AIBinder_Weak* a = nullptr) : ScopedA(a) {}
    ~SpAIBinder_Weak() {}
    SpAIBinder_Weak(SpAIBinder_Weak&&) = default;
