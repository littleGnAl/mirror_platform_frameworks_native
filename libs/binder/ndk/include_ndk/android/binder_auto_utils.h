...
class ScopedAIBinder_DeathRecipient
      : public ScopedAResource<AIBinder_DeathRecipient*, void, AIBinder_DeathRecipient_delete, nullptr> {
public:
    /**
     * Takes ownership of a.
     */
 ...
 */
class ScopedAIBinder_Weak : public ScopedAResource<AIBinder_Weak*, void, AIBinder_Weak_delete, nullptr> {
public:
    /**
     * Takes ownership of a.
     */
