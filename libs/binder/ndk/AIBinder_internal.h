...
struct AIBinder {
    ...
    // FIXME: we can query the class if this is a remote binder
    static AIBinder* newRemoteBinder(::android::sp<::android::IBinder> remoteBinder);

    const AIBinder_Class* getClass() { return mClazz; }
...
struct AIBinder_Class {
    ...
    const char* getInterfaceDescriptor() { return mInterfaceDescriptor; }
...
private:
    const char* mInterfaceDescriptor;
};