...
def main():
    ...
    for pretty, cpp in data_types:
        ...
        arg_type = cpp + "* value"
        if nca: arg_type = "void* arrayData, AParcel_" + pretty.lower() + "_array_getter getter"
        args = "value"
    ...
    for pretty, cpp in data_types:
        ...
        pre_header += " */\n"
        pre_header += "typedef " + getter_return + " (*" + getter_type + ")(void* arrayData" + extra_getter_args + ");\n\n"
        ...
        cpp_helper += " */\n"
        cpp_helper += "static inline " + getter_return + " AParcel_" + pretty.lower() + "_std_vector_getter(void* vectorData" + extra_getter_args + ") {\n"
        ...
        cpp_helper += " */\n"
        cpp_helper += "static inline binder_status_t AParcel_write" + pretty + "Array(AParcel* parcel, std::vector<" + cpp + ">* vec) {\n"
        write_args = "vec->data()"
        if nca: write_args = "static_cast<void*>(vec), AParcel_" + pretty.lower() + "_std_vector_getter"
