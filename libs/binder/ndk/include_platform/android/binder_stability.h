...
/**
 * This interface has system<->vendor<->apex stability
 */
void AIBinder_markVintfStability(AIBinder* binder);

#ifndef __ANDROID_VNDK__
/**
 * This interface has system<->apex stability
 */
__attribute__((weak)) void AIBinder_markSystemApiStability(AIBinder* binder);
#endif
