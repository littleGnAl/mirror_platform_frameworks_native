 ...
 *
 * WARNING: a lock is held when this method is called in order to prevent races
 * deleting cookie. Do not make synchronous binder calls when implementing this
 ...
 *
 * After this method is called, the callback is guaranteed to no longer be called.
 *
