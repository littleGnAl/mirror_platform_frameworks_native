...
/**
 * Get alignment used for allocations. The offset (see AMemory_getOffset) will
 * always be a multiple of this. Some clients may want to take this into account
 * for memory optimizations.
 *
 * The value for this corresponds to the alignment for memory heaps created with
 * AMemoryHeap_newDealer.
 *
 * \return alignment value in bytes
 */
size_t AMemoryHeap_getDealerMemoryAlignment();
