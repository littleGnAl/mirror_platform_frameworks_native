...
set<String16> PersistableBundle::getBooleanKeys() {
    return getKeys(mBoolMap);
}

set<String16> PersistableBundle::getIntKeys() {
    return getKeys(mIntMap);
}

set<String16> PersistableBundle::getLongKeys() {
    return getKeys(mLongMap);
}

set<String16> PersistableBundle::getDoubleKeys() {
    return getKeys(mDoubleMap);
}

set<String16> PersistableBundle::getStringKeys() {
    return getKeys(mStringMap);
}

set<String16> PersistableBundle::getBooleanVectorKeys() {
    return getKeys(mBoolVectorMap);
}

set<String16> PersistableBundle::getIntVectorKeys() {
    return getKeys(mIntVectorMap);
}

set<String16> PersistableBundle::getLongVectorKeys() {
    return getKeys(mLongVectorMap);
}

set<String16> PersistableBundle::getDoubleVectorKeys() {
    return getKeys(mDoubleVectorMap);
}

set<String16> PersistableBundle::getStringVectorKeys() {
    return getKeys(mStringVectorMap);
}

set<String16> PersistableBundle::getPersistableBundleKeys() {
