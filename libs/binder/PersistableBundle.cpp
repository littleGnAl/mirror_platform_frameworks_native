...
void PersistableBundle::putBoolean(const String16& key, bool value) { mBoolMap[key] = value; }

void PersistableBundle::putInt(const String16& key, int32_t value) { mIntMap[key] = value; }

void PersistableBundle::putLong(const String16& key, int64_t value) { mLongMap[key] = value; }

void PersistableBundle::putDouble(const String16& key, double value) { mDoubleMap[key] = value; }
