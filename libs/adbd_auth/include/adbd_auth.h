...
void adbd_auth_prompt_user(AdbdAuthContext* ctx,
                           const char* public_key,
                           size_t len, void* arg) __INTRODUCED_IN(30);
...
// Returns the current #AdbdAuthCallbacks version.
//
// The version starts at 1, with version 1 corresponding to the
// #AdbdAuthCallbacksV1 struct.
//
// @return the current #AdbdAuthCallbacks version.
uint32_t adbd_auth_get_version(void) __INTRODUCED_IN(30);
