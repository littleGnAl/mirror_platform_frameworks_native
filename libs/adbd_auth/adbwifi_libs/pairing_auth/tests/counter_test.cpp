...
TEST(AdbWifiCounterTest, rollover_first_byte) {
    Counter<kTestCounterSize> counter;
    memset(counter.data(), 0, counter.size());
...
TEST(AdbWifiCounterTest, multiple_rollover) {
    Counter<kTestCounterSize> counter;
...
TEST(AdbWifiCounterTest, full_rollover) {
    Counter<kTestCounterSize> counter;
    memset(counter.data(), 0xFF, counter.size());
    counter.Increase();
