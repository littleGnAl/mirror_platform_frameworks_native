...
int network_connect(const std::string& host, int port, int type, int timeout,
                    std::string* error);
extern int adb_socket_accept(android::base::borrowed_fd serverfd, struct sockaddr* addr, socklen_t* addrlen);
#undef accept
#define accept ___xxx_accept

extern int adb_setsockopt(android::base::borrowed_fd fd,
                          int level,
                          int optname,
                          const void* optval,
                          socklen_t optlen);
...
static inline int adb_socket_accept(android::base::borrowed_fd serverfd, struct sockaddr* addr,
                                    socklen_t* addrlen) {
    int fd;
...
static __inline__ int adb_setsockopt(android::base::borrowed_fd fd,
                                     int level,
                                     int optname,
                                     const void* optval,
                                     socklen_t optlen) {
...
static inline void disable_tcp_nagle(android::base::borrowed_fd fd) {
    int off = 1;
