...
struct fdevent_context {
  public:
    ...
    fdevent* Create(android::base::unique_fd fd, std::variant<fd_func, fd_func2> func, void* arg);
    ...
    // final.
    android::base::unique_fd Destroy(fdevent* fde);
...
android::base::unique_fd fdevent_release(fdevent* fde);
