...
public:
    ...
    // Creates a PeerInfo
    static PeerInfo makePeerInfo(const std::string& guid,
    ...
    //
    // This depends on a DeviceIdentifier already being generated and saved to a file.
    // It can be generated by creating a DeviceIdentifier instance and calling
    // DeviceIdentifier::resetUniqueDeviceId(|guid|). The reason why it's not
    // baked into the keystore code is because the process may not have
    // sufficient permissions to write it to file.
