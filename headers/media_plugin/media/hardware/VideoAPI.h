...
constexpr float kDispPrimXLow = 0.0001;
constexpr float kDispPrimXHigh = 0.74;
constexpr float kDispPrimYLow = 0.0001;
constexpr float kDispPrimYHigh = 0.84;
constexpr float kMaxDispLuminanceLow = 5.0; // cd / m^2
constexpr float kMaxDispLuminanceHigh = 10000; // cd / m^2
constexpr float kMinDispLuminanceLow = 0.0001; //  cd / m^2
constexpr float kMinDispLuminanceHigh = 5.0; // cd / m^2
constexpr uint16_t kContentLightLevelLow = 1;
