...
void* LoadLibrary(const android_dlextinfo& dlextinfo, const char* subname) {
    char name[PROPERTY_VALUE_MAX + 7];
    snprintf(name, sizeof(name), "vulkan.%s.so", subname);
