...
bool InitDispatchTable(
    ...
    INIT_PROC(true, dev, ResetQueryPool);
    ...
    INIT_PROC(true, dev, CreateRenderPass2);
    INIT_PROC(true, dev, CmdBeginRenderPass2);
    INIT_PROC(true, dev, CmdNextSubpass2);
    INIT_PROC(true, dev, CmdEndRenderPass2);
    INIT_PROC(true, dev, GetSemaphoreCounterValue);
    INIT_PROC(true, dev, WaitSemaphores);
    INIT_PROC(true, dev, SignalSemaphore);
    ...
    INIT_PROC(true, dev, CmdDrawIndirectCount);
    INIT_PROC(true, dev, CmdDrawIndexedIndirectCount);
    INIT_PROC(true, dev, GetBufferOpaqueCaptureAddress);
    INIT_PROC(true, dev, GetBufferDeviceAddress);
    INIT_PROC(true, dev, GetDeviceMemoryOpaqueCaptureAddress);
    // clang-format on
