 ...
 *  - {@link AOBB_STATE_MOUNTED} = 1
 *  - {@link AOBB_STATE_UNMOUNTED} = 2
 *  - {@link AOBB_STATE_ERROR_INTERNAL} = 20
 *  - {@link AOBB_STATE_ERROR_COULD_NOT_MOUNT} = 21
 *  - {@link AOBB_STATE_ERROR_COULD_NOT_UNMOUNT} = 22
 *  - {@link AOBB_STATE_ERROR_NOT_MOUNTED} = 23
 *  - {@link AOBB_STATE_ERROR_ALREADY_MOUNTED} = 24
 *  - {@link AOBB_STATE_ERROR_PERMISSION_DENIED} = 25
 */
