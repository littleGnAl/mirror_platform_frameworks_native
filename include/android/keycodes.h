...
enum {
    ...
    AKEYCODE_EPG = 4001,
    AKEYCODE_QUICK_MENU = 4020,
    AKEYCODE_ZOOM = 4034,
    AKEYCODE_RF_LINK_STOP = 4035,
    AKEYCODE_AUDIO = 4036,
    AKEYCODE_RC_RF_UNCONNECT = 4048,
    AKEYCODE_RF_LINK_S = 4052,
    AKEYCODE_RF_LINK_F = 4053,
    AKEYCODE_NUMBER = 4056,
    AKEYCODE_USB_MEDIA = 4057,
    AKEYCODE_NETFLIX = 4062,
    AKEYCODE_YOUTUBE = 4065,
    AKEYCODE_HULU = 4066,
    AKEYCODE_SET = 4077,
    AKEYCODE_LANG = 4084,
    AKEYCODE_TEXT = 4086,
    AKEYCODE_LIST = 4090,
    AKEYCODE_LINE_TV = 4093,
    AKEYCODE_EXIT = 4095,
    AKEYCODE_IQIYI = 4096,
    AKEYCODE_DISNEY = 4097,
    AKEYCODE_TOT = 4098,
    AKEYCODE_PRIMEVIDEO = 4099,
    AKEYCODE_OKKO = 4100,
    AKEYCODE_HD = 4101,
    AKEYCODE_ZEE = 4102,
    AKEYCODE_FPTPLAYER = 4103,
    AKEYCODE_SOURCE_NEXT = 4104,
    AKEYCODE_SOURCE_PREVIOUS = 4105,
    AKEYCODE_3_LINE_INPUT = 4121,
    AKEYCODE_BML = 4122,
    AKEYCODE_TERMINAL = 4123,
    AKEYCODE_BS = 4124,
    AKEYCODE_CS = 4125,
    AKEYCODE_RECORD_LIST = 4126,
    AKEYCODE_SCHEDULE_LIST = 4128,
    AKEYCODE_BUG_REPORT = 4129,
    AKEYCODE_FREEVIEW_PLAY = 4130,
    AKEYCODE_SATELLITE_BS_CS = 4131,
    AKEYCODE_BS_CS_4K = 4132,
    AKEYCODE_U_NEXT = 4133,
    AKEYCODE_ABEMA = 4134,
    AKEYCODE_GALAVIEW = 4135,
    AKEYCODE_STAN = 4136,
    AKEYCODE_DASHBOARD = 4137,
    AKEYCODE_WATCHLIST = 4138,
    AKEYCODE_GLOBAL_PLAY = 4503,
    AKEYCODE_CMP = 4504,
    AKEYCODE_VGA = 4505,
    AKEYCODE_AV1 = 4506,
    AKEYCODE_HDMI1 = 4507,
