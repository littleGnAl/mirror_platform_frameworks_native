...
enum {
    ...
    AKEYCODE_CAMERA_MODE_POPOUT = 296,
    /** MULTIVIEW Mode key for camera device */
    AKEYCODE_CAMERA_MODE_MULTIVIEW = 297,
    /** SNAP Mode key for camera device */
    AKEYCODE_CAMERA_MODE_SNAP = 298,
    /** PANORAMA Mode key for camera device */
    AKEYCODE_CAMERA_MODE_PANORAMA = 299,
    /** SLOWMOTION Mode key for camera device */
    AKEYCODE_CAMERA_MODE_SLOWMOTION = 300,
    /** TIMELAPSE Mode key for camera device */
    AKEYCODE_CAMERA_MODE_TIMELAPSE = 301,
    /** Camera scene 1 for camera device */
    AKEYCODE_CAMERA_SCENE_1 = 302,
    /** Camera scene 2 for camera device */
    AKEYCODE_CAMERA_SCENE_2 = 303,
    /** Camera scene 3 for camera device */
    AKEYCODE_CAMERA_SCENE_3 = 304,
    /** Camera scene custom for camera device */
    AKEYCODE_CAMERA_SCENE_CUSTOM = 305,
    /** Next key for camera device */
    AKEYCODE_CAMERA_CONTROL_NEXT = 306,
    /** Previous key for camera device */
    AKEYCODE_CAMERA_CONTROL_PREVIOUS = 307,
    /** Record key for camera device */
    AKEYCODE_CAMERA_RECORD = 308,
    /** Power key for camera device */
    AKEYCODE_CAMERA_POWER = 309
