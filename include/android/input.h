...
enum {
     ...
     * Use {@link AMotionEvent_getAxisValue} to retrieve the information from #AMOTION_EVENT_AXIS_VSCROLL
...
enum AMotionClassification : uint32_t {
     ...
     * starting in #AMOTION_EVENT_CLASSIFICATION_AMBIGUOUS_GESTURE will eventually resolve into either #AMOTION_EVENT_CLASSIFICATION_DEEP_PRESS or #AMOTION_EVENT_CLASSIFICATION_NONE.
 ...
 * After returning, the specified {@link AInputEvent}* object becomes invalid and should no longer be used.
...
/**
 * Creates a native {@link AInputEvent}* object that is a copy of the specified Java android.view.KeyEvent.
