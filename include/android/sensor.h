...
/**
 * {@link ASensorManager} manages sensors and events queues.
 * 
 * An instance of {@link ASensorManager} can be obtained using
 * ASensorManager_getInstance().
 * 
 * This module provides a set of functions for accessing and listing
 * hardware sensors and creating and destroying event queues:
...
/**
 * {@link ASensorEventQueue} returns {@link ASensorEvent} from hardware sensors.
 * 
 * An instance can be obtained using ASensorManager_getInstance().
 *
