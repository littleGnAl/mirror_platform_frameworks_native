 ...
 * uid (if set) is kept when the socket is sent to another process using binder
 ...
 * app by calling this method with its own UID (or -1 or calling
 ...
 * previously configured tag & uid. If the socket was created by another UID or
 * was previously tagged by another UID, calling this function will clear the
