 ...
 * There are still other error codes that may provided by -errno of getsockopt()
 * or by BPF maps read/write sys calls, which are set appropriately.
 *
 * Available since API level 33.
 */
 ...
 * -EBADF           Bad socketfd.
 * Other error codes are either provided by -errno of getsockopt(), or by BPF
 * map element deletion sys call, which are set appropriately.
 *
 * Available since API level 33.
 */
