...
static const InputEventLabel KEYCODES[] = {
    ...
    DEFINE_KEYCODE(EPG),
    DEFINE_KEYCODE(QUICK_MENU),
    DEFINE_KEYCODE(ZOOM),
    DEFINE_KEYCODE(RF_LINK_STOP),
    DEFINE_KEYCODE(AUDIO),
    DEFINE_KEYCODE(RC_RF_UNCONNECT),
    DEFINE_KEYCODE(RF_LINK_S),
    DEFINE_KEYCODE(RF_LINK_F),
    DEFINE_KEYCODE(NUMBER),
    DEFINE_KEYCODE(USB_MEDIA),
    ...
    DEFINE_KEYCODE(TEXT),
    DEFINE_KEYCODE(LIST),
    DEFINE_KEYCODE(LINE_TV),
    DEFINE_KEYCODE(EXIT),
    DEFINE_KEYCODE(IQIYI),
    DEFINE_KEYCODE(DISNEY),
    DEFINE_KEYCODE(TOT),
    DEFINE_KEYCODE(PRIMEVIDEO),
    DEFINE_KEYCODE(OKKO),
    DEFINE_KEYCODE(HD),
    DEFINE_KEYCODE(ZEE),
    DEFINE_KEYCODE(FPTPLAYER),
    DEFINE_KEYCODE(SOURCE_NEXT),
    DEFINE_KEYCODE(SOURCE_PREVIOUS),
    DEFINE_KEYCODE(3_LINE_INPUT),
    DEFINE_KEYCODE(BML),
    DEFINE_KEYCODE(TERMINAL),
    DEFINE_KEYCODE(BS),
    DEFINE_KEYCODE(CS),
    DEFINE_KEYCODE(RECORD_LIST),
    DEFINE_KEYCODE(SCHEDULE_LIST),
    DEFINE_KEYCODE(BUG_REPORT),
    DEFINE_KEYCODE(FREEVIEW_PLAY),
    DEFINE_KEYCODE(SATELLITE_BS_CS),
    DEFINE_KEYCODE(BS_CS_4K),
    DEFINE_KEYCODE(U_NEXT),
    DEFINE_KEYCODE(ABEMA),
    DEFINE_KEYCODE(GALAVIEW),
    DEFINE_KEYCODE(STAN),
    DEFINE_KEYCODE(DASHBOARD),
    DEFINE_KEYCODE(WATCHLIST),
    DEFINE_KEYCODE(GLOBAL_PLAY),
    DEFINE_KEYCODE(CMP),
    DEFINE_KEYCODE(VGA),
    DEFINE_KEYCODE(AV1),
    DEFINE_KEYCODE(HDMI1),
    DEFINE_KEYCODE(HDMI2),
    DEFINE_KEYCODE(HDMI3),
    DEFINE_KEYCODE(TV_ON),
    DEFINE_KEYCODE(TV_OFF),
    DEFINE_KEYCODE(HDMI4),
    DEFINE_KEYCODE(AV2),
