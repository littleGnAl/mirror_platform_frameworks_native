...
static const InputEventLabel KEYCODES[] = {
    ...
    DEFINE_KEYCODE(5IN1_ENTER),
    DEFINE_KEYCODE(TCL_EPG),
    DEFINE_KEYCODE(TCL_QUICK_MENU),
    DEFINE_KEYCODE(TCL_ZOOM),
    DEFINE_KEYCODE(TCL_RF_LINK_STOP),
    DEFINE_KEYCODE(TCL_AUDIO),
    DEFINE_KEYCODE(TCL_RC_RF_UNCONNECT),
    DEFINE_KEYCODE(TCL_RF_LINK_S),
    DEFINE_KEYCODE(TCL_RF_LINK_F),
    DEFINE_KEYCODE(TCL_NUMBER),
    DEFINE_KEYCODE(TCL_USB_MEDIA),
    DEFINE_KEYCODE(TCL_NETFLIX),
    DEFINE_KEYCODE(TCL_YOUTUBE),
    DEFINE_KEYCODE(TCL_HULU),
    DEFINE_KEYCODE(TCL_SET),
    DEFINE_KEYCODE(TCL_LAST_CHANNEL),
    DEFINE_KEYCODE(TCL_LANG),
    DEFINE_KEYCODE(TCL_TEXT),
    DEFINE_KEYCODE(TCL_LIST),
    DEFINE_KEYCODE(TCL_LINE_TV),
    DEFINE_KEYCODE(TCL_EXIT),
    DEFINE_KEYCODE(TCL_IQIYI),
    DEFINE_KEYCODE(TCL_DISNEY),
    DEFINE_KEYCODE(TCL_TOT),
    DEFINE_KEYCODE(TCL_PRIMEVIDEO),
    DEFINE_KEYCODE(TCL_OKKO),
    DEFINE_KEYCODE(TCL_HD),
    DEFINE_KEYCODE(TCL_ZEE),
    DEFINE_KEYCODE(TCL_FPTPLAYER),
    DEFINE_KEYCODE(TCL_SOURCE_NEXT),
    DEFINE_KEYCODE(TCL_SOURCE_PREVIOUS),
    DEFINE_KEYCODE(TCL_11),
    DEFINE_KEYCODE(TCL_12),
    DEFINE_KEYCODE(TCL_3_LINE_INPUT),
    DEFINE_KEYCODE(TCL_BML),
    DEFINE_KEYCODE(TCL_TERMINAL),
    DEFINE_KEYCODE(TCL_BS),
    DEFINE_KEYCODE(TCL_CS),
    DEFINE_KEYCODE(TCL_RECORD_LIST),
    DEFINE_KEYCODE(TCL_SCHEDULE_LIST),
    DEFINE_KEYCODE(TCL_BUG_REPORT),
    DEFINE_KEYCODE(TCL_FREEVIEW_PLAY),
    DEFINE_KEYCODE(TCL_SATELLITE_BS_CS),
    DEFINE_KEYCODE(TCL_BS_CS_4K),
    DEFINE_KEYCODE(TCL_U_NEXT),
    DEFINE_KEYCODE(TCL_ABEMA),
    DEFINE_KEYCODE(TCL_GALAVIEW),
    DEFINE_KEYCODE(TCL_STAN),
    DEFINE_KEYCODE(TCL_DASHBOARD),
    DEFINE_KEYCODE(TCL_WATCHLIST),
    DEFINE_KEYCODE(TCL_GLOBAL_PLAY),
    DEFINE_KEYCODE(TCL_CMP),
    DEFINE_KEYCODE(TCL_VGA),
    DEFINE_KEYCODE(TCL_AV1),
    DEFINE_KEYCODE(TCL_HDMI1),
    DEFINE_KEYCODE(TCL_HDMI2),
    DEFINE_KEYCODE(TCL_HDMI3),
    DEFINE_KEYCODE(TCL_TV_ON),
    DEFINE_KEYCODE(TCL_TV_OFF),
    DEFINE_KEYCODE(TCL_HDMI4),
    DEFINE_KEYCODE(TCL_AV2),
    DEFINE_KEYCODE(TCL_MOUSE_KEY),
