...
static const InputEventLabel KEYCODES[] = {
    ...
    DEFINE_KEYCODE(USER_FUNCTION_1),
    DEFINE_KEYCODE(USER_FUNCTION_2),
    DEFINE_KEYCODE(USER_FUNCTION_3),
    DEFINE_KEYCODE(USER_FUNCTION_4),
    DEFINE_KEYCODE(SIM_SWITCH),
    DEFINE_KEYCODE(ROTATION),
    DEFINE_KEYCODE(MESSAGE),
    DEFINE_KEYCODE(ACCESSORY_CAMERA),
    DEFINE_KEYCODE(VR_OK),
    DEFINE_KEYCODE(VR_BACK),
    DEFINE_KEYCODE(CAMERA_MODE_APERTURE),
    DEFINE_KEYCODE(CAMERA_MODE_AUTO),
    DEFINE_KEYCODE(CAMERA_MODE_CAMCORDER),
    DEFINE_KEYCODE(CAMERA_MODE_MANUAL),
    DEFINE_KEYCODE(CAMERA_MODE_PROGRAM),
    DEFINE_KEYCODE(CAMERA_MODE_SHUTTER),
    DEFINE_KEYCODE(CAMERA_MODE_POPOUT),
    DEFINE_KEYCODE(CAMERA_MODE_MULTIVIEW),
    DEFINE_KEYCODE(CAMERA_MODE_SNAP),
    DEFINE_KEYCODE(CAMERA_MODE_PANORAMA),
    DEFINE_KEYCODE(CAMERA_MODE_SLOWMOTION),
    DEFINE_KEYCODE(CAMERA_MODE_TIMELAPSE),
    DEFINE_KEYCODE(CAMERA_SCENE_1),
    DEFINE_KEYCODE(CAMERA_SCENE_2),
    DEFINE_KEYCODE(CAMERA_SCENE_3),
    DEFINE_KEYCODE(CAMERA_SCENE_CUSTOM),
    DEFINE_KEYCODE(CAMERA_CONTROL_NEXT),
    DEFINE_KEYCODE(CAMERA_CONTROL_PREVIOUS),
    DEFINE_KEYCODE(CAMERA_RECORD),
    DEFINE_KEYCODE(CAMERA_POWER),
