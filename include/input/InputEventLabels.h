...
static const InputEventLabel KEYCODES[] = {
    ...
    DEFINE_KEYCODE(QMEMO),
    DEFINE_KEYCODE(QSLIDE),
    DEFINE_KEYCODE(USER_DEFINE),
    DEFINE_KEYCODE(SIM_SWITCH),
    DEFINE_KEYCODE(ROTATION),
    DEFINE_KEYCODE(MESSAGE),
    DEFINE_KEYCODE(CAMERA_ONOFF_TOGGLE),
    DEFINE_KEYCODE(CAMERA_MODE_APERTURE_PRIORITY),
    ...
    DEFINE_KEYCODE(CAMERA_MODE_SHUTTER_PRIORITY),
    ...
    DEFINE_KEYCODE(CAMERA_MODE_CUSTOM),
