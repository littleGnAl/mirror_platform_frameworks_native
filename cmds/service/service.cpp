...
static bool split(const std::string& s, std::vector<int>& v) {
    const char* delim = ",";
                ...
                if (service != NULL && ifName.size() > 0) {
                    ...
                    while (optind < argc) {
                        if (strcmp(argv[optind], "i32") == 0) {
                            ...
                            optind++;
                            if (optind >= argc) {
                                aerr << "service: no array supplied for 'ia32'" << endl;
                                wantsUsage = true;
                                result = 10;
                                break;
                            }
                            ...
                            if (!validFormat) {
                                aerr << "service: array format supplied for 'ia32' is not correct" << endl;
                                wantsUsage = true;
                                result = 10;
                                break;
                            }
                            ...
                            split(s, array);
                            data.writeInt32Array(array.size(), array.data());
                            optind++;
