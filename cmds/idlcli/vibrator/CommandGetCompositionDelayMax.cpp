...
class CommandGetCompositionDelayMax : public Command {
    std::string getDescription() const override { return "Retrieves vibrator composition delay max."; }
...
static const auto Command =
        CommandRegistry<CommandVibrator>::Register<CommandGetCompositionDelayMax>("getCompositionDelayMax");
