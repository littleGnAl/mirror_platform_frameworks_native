...
sp<IBinder> ServiceManager::tryGetService(const std::string& name, bool startIfNotFound) {
    ...
    if (out) {
        ...
        // right here is always going to be important for services with multiple
        // services.
...
bool ServiceManager::handleServiceClientCallback(size_t knownClients,
    ...
    bool hasClients = static_cast<size_t>(count) > knownClients;
    ...
    // May be different than 'hasClients'
