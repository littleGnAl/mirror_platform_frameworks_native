...
// This program no longer trigger the dumpstate service nor start a call to
// dumpstate to generate flat bugreports to stdout.
int main() {
  fprintf(stderr, "=============================================================================\n");
  ...
  fprintf(stderr, "WARNING: Or redirect on the host use: adb bugreport --stream > filename.zip\n");
