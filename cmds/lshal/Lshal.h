...
public:
    ...
    // Output streams are stored in a stack (mOut). Use these two methods
    // to temporary override out() to write to a different stream.
    void pushOutputStream(NullableOStream<std::ostream> out);
