 ...
 */
struct PipeRelay {
    static android::base::Result<std::unique_ptr<PipeRelay>> create(std::ostream& os,
...
private:
    ...
    static void thread(android::base::unique_fd rfd, android::base::unique_fd rfdTrigger, std::ostream* out,
