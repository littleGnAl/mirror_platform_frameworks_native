...
void Lshal::usage() const {
    mErr
        ...
        << "             Specifies a comma-separated list of option strings to use" << std::endl
        << "             in calls to IBase::debug() for the given interface. " << std::endl
        << "             Note that options MUST NOT contain comma or colon characters." << std::endl
        << "             This commandline option can be specified multiple times." << std::endl
