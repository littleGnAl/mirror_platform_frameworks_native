...
static Architecture fromHidlArchitecture(::android::hidl::base::V1_0::Architecture a) {
    switch (a) {
        case ::android::hidl::base::V1_0::Architecture::IS_64BIT:
            return ARCH64;
        case ::android::hidl::base::V1_0::Architecture::IS_32BIT:
            return ARCH32;
        case ::android::hidl::base::V1_0::Architecture::UNKNOWN: // fallthrough
        default:
            return ARCH_UNKNOWN;
    }
}
    ...
    auto ret = timeoutIPC(manager, &IServiceManager::debugDump, [&] (const auto &infos) {
        ...
        for (const auto &info : infos) {
            ...
            entries.emplace(std::string{interfaceName}, TableEntry{
                ...
                .arch = ARCH_UNKNOWN,
                .source = LIST_DLLIB
            }).first->second.arch |= fromHidlArchitecture(info.arch);
        }
    ...
    auto ret = timeoutIPC(manager, &IServiceManager::debugDump, [&] (const auto &infos) {
        for (const auto &info : infos) {
            putEntry({
                ...
                .arch = fromHidlArchitecture(info.arch),
