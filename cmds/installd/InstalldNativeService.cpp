 ...
 */
static std::atomic<bool> internalStorageWithProjectID(false);
...
static bool internal_storage_has_project_id() {
    ...
    std::call_once(flag, []() {
        ...
        internalStorageWithProjectID = access(using_project_ids.c_str(), F_OK) == 0;
    });
    return internalStorageWithProjectID;
}
