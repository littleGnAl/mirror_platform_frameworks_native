...
#define LOCK_USER() std::lock_guard<std::recursive_mutex> userLock(mUserIdLock[userId])

#define LOCK_PACKAGE() \
    std::lock_guard<std::recursive_mutex> packageLock(mPackageNameLock[packageName])
