...
/* dexopt status flags matching those in dalvik.system.DexFile */
#define DEXOPT_UP_TO_DATE            0
#define DEXOPT_PATCHOAT_NEEDED       1
#define DEXOPT_DEXOPT_NEEDED         2
...
int dexopt(const char *apk_path, uid_t uid, bool is_public, const char *pkgName,
           const char *instruction_set, int dexopt_status, bool vm_safe_mode,
           bool debuggable);
