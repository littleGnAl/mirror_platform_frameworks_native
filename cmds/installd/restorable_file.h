...
public:
    ...
    // Closes work file, delete it and reset all internal states into default states.
    void reset();

    // Closes work file and close all files including work file, backup file and regular file.
    ...
    // Closes existing work file and make it a regular file.
    ...
    // Cancels the commit and restore the backup file into the regular one. If renaming fails,
