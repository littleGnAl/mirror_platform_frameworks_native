...
class RunDex2Oat : public ExecVHelper {
  public:
    RunDex2Oat(int zip_fd,
        ...
        const char* dex2oat_bin = select_dex2oat_bin(background_job_compile);
        ...
        // Get the relative path to the input file.
        {
            ...
            AddArg(StringPrintf("--zip-location=%s", relative_input_file_name));
    ...
    static const char* select_dex2oat_bin(bool background_job_compile) {
