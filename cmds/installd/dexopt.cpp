...
int dexopt(const char* dex_path, uid_t uid, const char* pkgname, const char* instruction_set,
    ...
    *completed = true;
    ...
    // Keep the original file for these three even if it fails. Only tmp files are updated from
    // dex2oat.
    ...
    out_oat.CommitWorkFile();
    out_vdex.CommitWorkFile();
    out_image.CommitWorkFile();
    reference_profile.DisableCleanup();
