...
static bool process_dexoptanalyzer_result(const std::string& dex_path, int result,
    ...
    switch (static_cast<art::dexoptanalyzer::ExitStatus>(result)) {
        case art::dexoptanalyzer::ExitStatus::kNoDexOptNeeded:
            *dexopt_needed_out = NO_DEXOPT_NEEDED; return true;
        case art::dexoptanalyzer::ExitStatus::kDex2OatFromScratch:
            *dexopt_needed_out = DEX2OAT_FROM_SCRATCH; return true;
        case art::dexoptanalyzer::ExitStatus::kDex2OatForBootImageOdex:
            *dexopt_needed_out = -DEX2OAT_FOR_BOOT_IMAGE; return true;
        case art::dexoptanalyzer::ExitStatus::kDex2OatForFilterOdex:
            *dexopt_needed_out = -DEX2OAT_FOR_FILTER; return true;
        case art::dexoptanalyzer::ExitStatus::kDex2OatForRelocationOdex:
            *dexopt_needed_out = -DEX2OAT_FOR_RELOCATION; return true;
        case art::dexoptanalyzer::ExitStatus::kDex2OatForBootImageOat:
        case art::dexoptanalyzer::ExitStatus::kDex2OatForFilterOat:
        case art::dexoptanalyzer::ExitStatus::kDex2OatForRelocationOat:
        ...
        case art::dexoptanalyzer::ExitStatus::kBootImageError:
        case art::dexoptanalyzer::ExitStatus::kErrorInvalidArguments:
        case art::dexoptanalyzer::ExitStatus::kErrorCannotCreateRuntime:
        case art::dexoptanalyzer::ExitStatus::kErrorUnknownDexOptNeeded:
            break;
    }
