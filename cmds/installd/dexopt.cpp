...
static void run_dex2oat(int zip_fd, int oat_fd, int input_vdex_fd, int output_vdex_fd, int image_fd,
    ...
    const char* dex2oat_bin = "/apex/com.android.art/bin/dex2oat";
    constexpr const char* kDex2oatDebugPath = "/apex/com.android.art/bin/dex2oatd";
...
static void run_profman(const std::vector<unique_fd>& profile_fds,
    ...
    const char* profman_bin =
        is_debug_runtime()
            ? "/apex/com.android.art/bin/profmand"
...
static void run_profman_dump(const std::vector<unique_fd>& profile_fds,
    ...
    static const char* PROFMAN_BIN = "/apex/com.android.art/bin/profman";
...
static void exec_dexoptanalyzer(const std::string& dex_file, int vdex_fd, int oat_fd,
    ...
    const char* dexoptanalyzer_bin =
            is_debug_runtime()
                    ? "/apex/com.android.art/bin/dexoptanalyzerd"
