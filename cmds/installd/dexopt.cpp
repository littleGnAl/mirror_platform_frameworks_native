...
//
// Return PROFILES_ANALYSIS_DONT_OPTIMIZE_SMALL_DELTA if the package should not optimize, and,
// as a special case returns PROFILES_ANALYSIS_DONT_OPTIMIZE_EMPTY_PROFILES is all profiles are
// empty.
