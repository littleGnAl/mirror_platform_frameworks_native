...
static const char* SelectExecutionBinary(const char* binary, const char* debug_binary,
        bool background_job_compile) {
    return SelectExecutionBinary(
        binary,
        debug_binary,
...
class RunDex2Oat : public ExecVHelper {
  public:
    RunDex2Oat(int zip_fd,
        ...
        const char* dex2oat_bin = SelectExecutionBinary(kDex2oatPath, kDex2oatDebugPath, background_job_compile);
...
class RunProfman : public ExecVHelper {
  public:
   void SetupArgs(const std::vector<unique_fd>& profile_fds,
        ...
        const char* profman_bin = SelectExecutionBinary(
...
class RunDexoptAnalyzer : public ExecVHelper {
 public:
    RunDexoptAnalyzer(const std::string& dex_file,
        ...
        const char* dexoptanalyzer_bin = SelectExecutionBinary(
