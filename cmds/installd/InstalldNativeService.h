...
private:
    ...
    std::unordered_map<userid_t, std::shared_ptr<std::recursive_mutex>> mUserIdLock;
    std::unordered_map<std::string, std::shared_ptr<std::recursive_mutex>> mPackageNameLock;
