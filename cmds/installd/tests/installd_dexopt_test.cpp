...
TEST_F(ProfileTest, ProfileDirOk) {
    ...
    std::string ref_profile_path = create_primary_reference_profile_package_dir_path(package_name_);
    ...
    CheckFileAccess(ref_profile_path, kTestAppGid, kTestAppGid, 0701 | S_IFDIR);
