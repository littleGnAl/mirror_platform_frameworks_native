...
TEST_F(DexoptTest, SelectExecutionBinary) {
    LOG(INFO) << "DexoptTestSelectExecutionBinary";
    ...
    ASSERT_STREQ(release, SelectExecutionBinary(
        release,
        debug,
    ...
    ASSERT_STREQ(debug, SelectExecutionBinary(
        release,
        debug,
        /*background_job_compile=*/ false,
