...
TEST_F(ServiceTest, CreateAppDataSnapshot_ClearsCache) {
  ...
  auto deleter = [&fake_package_ce_path, &fake_package_de_path,
      ...
      delete_dir_contents(fake_package_ce_path, true);
      delete_dir_contents(fake_package_de_path, true);
      delete_dir_contents_and_dir(fake_package_ce_cache_path, true);
      delete_dir_contents_and_dir(fake_package_ce_code_cache_path, true);
      delete_dir_contents_and_dir(fake_package_de_cache_path, true);
      delete_dir_contents_and_dir(fake_package_de_code_cache_path, true);
