...
TEST_F(UtilsTest, CreateDataUserProfilePackagePath) {
    EXPECT_EQ("/data/misc/profiles/cur/0/com.example",
            create_primary_cur_profile_package_dir_path(0, "com.example"));
    EXPECT_EQ("/data/misc/profiles/cur/1/com.example",
            create_primary_cur_profile_package_dir_path(1, "com.example"));
}
...
TEST_F(UtilsTest, CreateDataRefProfilePackagePath) {
    EXPECT_EQ("/data/misc/profiles/ref/com.example",
        create_primary_ref_profile_package_dir_path("com.example"));
}

TEST_F(UtilsTest, CreatePrimaryCurrentProfile) {
    std::string expected =
        create_primary_cur_profile_package_dir_path(1, "com.example") + "/primary.prof";
    EXPECT_EQ(expected,
...
TEST_F(UtilsTest, CreatePrimaryReferenceProfile) {
    std::string expected =
        create_primary_ref_profile_package_dir_path("com.example") + "/primary.prof";
    EXPECT_EQ(expected,
