...
// Make sure we do not overwrite a preexisting definition of `ANDROID_RUNTIME_APEX_BIN`.
#ifdef ANDROID_RUNTIME_APEX_BIN
#error "ANDROID_RUNTIME_APEX_BIN already defined"
#endif
