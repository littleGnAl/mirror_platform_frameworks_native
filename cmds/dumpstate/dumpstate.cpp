...
using DumpstateStatusAidl = ::aidl::android::hardware::dumpstate::DumpstateStatus;
...
static void DoDumpstateBoardHidl(sp<IDumpstateDevice_1_0> dumpstate_device_1_0,
        ...
        const DumpstateMode dumpstate_hal_mode,
    ...
    ScopedNativeHandle handle(native_handle_create(static_cast<int>(dumpstate_fds.size()), 0),
                              [](native_handle_t* handle) {
                                  // we dont close file handle's here via native_handle_close(handle)
    ...
    if (dumpstate_device_1_1 != nullptr) {
        ...
        dumpstate_board_task = DumpstateBoardTask([timeout_sec, dumpstate_hal_mode, dumpstate_device_1_1, &handle]() -> bool {
...
static void DoDumpstateBoardAidl(std::shared_ptr<IDumpstateDeviceAidl> dumpstate_aidl,
        std::vector<::ndk::ScopedFileDescriptor> & dumpstate_fds,
        const DumpstateModeAidl dumpstate_hal_mode,
        const size_t timeout_sec) {
    ...
    dumpstate_board_task = DumpstateBoardTask(
        ...
        DumpstateStatusAidl dumpstateStatus = DumpstateStatusAidl::ILLEGAL_ARGUMENT;
        ...
        if(dumpstateStatus != DumpstateStatusAidl::OK) {
...
static std::shared_ptr<IDumpstateDeviceAidl> GetDumpstateBoardAidlService() {
    ...
    const std::string aidl_instance_name = std::string(IDumpstateDeviceAidl::descriptor) + "/default";
    
    if( AServiceManager_isDeclared( aidl_instance_name.c_str() ) == false ) {
        MYLOGE("No IDumpstateDevice AIDL service declared\n");
        return nullptr;
    } 
...
void Dumpstate::DumpstateBoard(int out_fd) {
    ...
    if (dumpstate_aidl == nullptr) {
        MYLOGE("No IDumpstateDevice AIDL implementation\n");
    }
    ...
    if (dumpstate_device_1_0 == nullptr) {
        MYLOGE("No IDumpstateDevice HIDL implementation\n");
    }
    ...
    if( dumpstate_device_1_0 != nullptr ) {
        DoDumpstateBoardHidl(dumpstate_device_1_0, dumpstate_fds, 
            options_->dumpstate_hal_mode, timeout_sec);
    } 
    
    // call dumpstate AIDL APIs 
    if(dumpstate_aidl != nullptr) {
        DoDumpstateBoardAidl(dumpstate_aidl, dumpstate_fds, 
            options_->dumpstate_aidl_hal_mode, timeout_sec);
    }
...
static void SetOptionsFromMode(Dumpstate::BugreportMode mode, Dumpstate::DumpOptions* options,
    ...
    switch (mode) {
        case Dumpstate::BugreportMode::BUGREPORT_FULL:
            ...
            options->dumpstate_aidl_hal_mode = DumpstateModeAidl::FULL;
            break;
        case Dumpstate::BugreportMode::BUGREPORT_INTERACTIVE:
            ...
            options->dumpstate_aidl_hal_mode = DumpstateModeAidl::INTERACTIVE;
            break;
        case Dumpstate::BugreportMode::BUGREPORT_REMOTE:
            ...
            options->dumpstate_aidl_hal_mode = DumpstateModeAidl::REMOTE;
            break;
        case Dumpstate::BugreportMode::BUGREPORT_WEAR:
            options->do_progress_updates = true;
            options->do_screenshot = is_screenshot_requested;
            options->dumpstate_hal_mode = DumpstateMode::WEAR;
            options->dumpstate_aidl_hal_mode = DumpstateModeAidl::WEAR;
            break;
        ...
        case Dumpstate::BugreportMode::BUGREPORT_TELEPHONY:
            ...
            options->dumpstate_aidl_hal_mode = DumpstateModeAidl::CONNECTIVITY;
            break;
        case Dumpstate::BugreportMode::BUGREPORT_WIFI:
            options->wifi_only = true;
            options->do_screenshot = false;
            options->dumpstate_hal_mode = DumpstateMode::WIFI;
            options->dumpstate_aidl_hal_mode = DumpstateModeAidl::WIFI;
            break;
        case Dumpstate::BugreportMode::BUGREPORT_DEFAULT:
            break;
    }
...
static void LogDumpOptions(const Dumpstate::DumpOptions& options) {
    MYLOGI(
        ...
        "dumpstate_aidl_hal_mode: %s limited_only: %d args: %s\n",
        ...
        toString(options.dumpstate_hal_mode).c_str(), toString(options.dumpstate_aidl_hal_mode).c_str(),
