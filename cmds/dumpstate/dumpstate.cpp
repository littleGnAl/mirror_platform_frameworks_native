...
void Dumpstate::DumpstateBoard() {
    ...
    if (dumpstate_device_1_1 != nullptr) {
        ...
        dumpstate_board_task = DumpstateBoardTask([this, dumpstate_device_1_1, &handle]() -> bool {
            // We don't need to check getDeviceLoggingEnabled, the return status will be
            // DEVICE_LOGGING_NOT_ENABLED in that case. Plus, some instances of this HAL could be
            // lazy and exit between operations, requiring us to re-get things.
...
static void LogDumpOptions(const Dumpstate::DumpOptions& options) {
    ...
    MYLOGI("dumpstate_hal_mode: %d\n", options.dumpstate_hal_mode);
