...
static void DoDumpstateBoardHidl(const sp<dumpstate_hal_hidl_1_0::IDumpstateDevice> dumpstate_hal_1_0,
...
void Dumpstate::DumpstateBoard(int out_fd) {
    ...
    // get dumpstate HAL HIDL implementation
    sp<dumpstate_hal_hidl_1_0::IDumpstateDevice> dumpstate_hal_handle_hidl_1_0(
        dumpstate_hal_hidl_1_0::IDumpstateDevice::getService());
    if (dumpstate_hal_handle_hidl_1_0 == nullptr) {
        MYLOGI("No IDumpstateDevice HIDL HAL implementation\n");
    }
