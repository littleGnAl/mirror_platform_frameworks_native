...
interface IDumpstate {
     ...
     *
     * Returns a an identifier of the bugreport process running in the background.
     */
    int /*requestId*/ startBugreport(int bugreportType, int fd, IDumpstateListener listener,
                                     in DumpstateOptions options);
}
