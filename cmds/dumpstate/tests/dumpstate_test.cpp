...
TEST_F(DumpPoolTest, EnqueueTaskWithFd) {
    ...
    auto t1 = dump_pool_->enqueueTaskWithFd(/* duration_title = */"1", dump_func_1, std::placeholders::_1);
    auto t2 = dump_pool_->enqueueTaskWithFd(/* duration_title = */"2", dump_func_2, std::placeholders::_1);
    auto t3 = dump_pool_->enqueueTaskWithFd(/* duration_title = */"3", dump_func_3, std::placeholders::_1);
